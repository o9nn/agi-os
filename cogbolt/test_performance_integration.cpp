...
int loadTime = modelSize_ / 1000000;
...
models.emplace_back(std::make_unique<MockAIModel>("text_classifier", 10000000));
models.emplace_back(std::make_unique<MockAIModel>("sentiment_analyzer", 5000000));
models.emplace_back(std::make_unique<MockAIModel>("summarizer", 15000000));
{
...
{1024 * 1024, "texture_buffer"},
{512 * 1024, "audio_buffer"},
{256 * 1024, "code_cache"},
{128 * 1024, "ui_elements"},
{64 * 1024, "small_buffers"}
};
