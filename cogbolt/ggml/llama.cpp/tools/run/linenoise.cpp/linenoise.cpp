...
static size_t defaultPrevCharLen(const char * buf, size_t , size_t pos, size_t * col_len) {
size_t end = pos;
while (pos > 0) {
...
int rpos = (pcollen + l->oldcolpos + l->cols) / l->cols;
int rpos2;
int col;
...
rpos2 = (pcollen + colpos2 + l->cols) / l->cols;
if (rows - rpos2 > 0) {
