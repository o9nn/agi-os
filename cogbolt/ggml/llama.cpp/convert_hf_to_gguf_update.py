...
parser.add_argument('--full', action='store_true', help='download full list of models - make sure you have access to all of them')
parser.add_argument('--check-missing', action='store_true', help='only check for missing pre-tokenizer hashes')
parser.add_argument('hf_token', help='optional HF token', nargs='?')
