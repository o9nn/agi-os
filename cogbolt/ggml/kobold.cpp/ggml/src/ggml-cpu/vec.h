...
svfloat32_t t0 = svmul_f32_m(pg, src, log2_e);
svfloat32_t t1 = svrintm_f32_m(inactive1, pg, t0);
svint32_t t2 = svcvt_s32_f32_m(inactive2, pg, t1);
t1 = svsub_f32_m(pg, t0, t1);
t1 = svadd_f32_m(pg, t1, one);
svuint32_t t3 = svlsr_n_u32_m(pg, svreinterpret_u32_f32(t1), 17);
svfloat32_t t4 = svexpa_f32(t3);
t4 = svscale_f32_m(pg, t4, t2);
svfloat32_t t5 = svreinterpret_f32_u32(svand_u32_m(pg, svreinterpret_u32_f32(t1), not_mask17));
t5 = svsub_f32_m(pg, t1, t5);
t0 = svmla_f32_m(pg, ln2, t5, half_ln2_sq);
t0 = svmla_f32_m(pg, one, t5, t0);
t0 = svmul_f32_m(pg, t0, t4);
return t0;
}
#endif
