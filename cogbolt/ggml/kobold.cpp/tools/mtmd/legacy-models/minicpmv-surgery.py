...
config.auto_map = {'AutoConfig': 'configuration_minicpm.MiniCPMConfig', 'AutoModel': 'modeling_minicpm.MiniCPMModel', 'AutoModelForCausalLM': 'modeling_minicpm.MiniCPMForCausalLM', 'AutoModelForSeq2SeqLM': 'modeling_minicpm.MiniCPMForCausalLM', 'AutoModelForSequenceClassification': 'modeling_minicpm.MiniCPMForSequenceClassification'}
