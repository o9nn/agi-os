...
ctx_size += n_embd*ggml_v2_type_sizef(GGML_V2_TYPE_F32);
ctx_size += n_vocab*n_embd*ggml_v2_type_sizef(wtype);
ctx_size += n_ctx*n_embd*ggml_v2_type_sizef(GGML_V2_TYPE_F32);
ctx_size += n_vocab*n_embd*ggml_v2_type_sizef(wtype);
...
ctx_size += n_layer*(4*n_embd*n_embd*ggml_v2_type_sizef(wtype));
ctx_size += n_layer*( n_embd*ggml_v2_type_sizef(GGML_V2_TYPE_F32));
ctx_size += 1.5*(n_ctx*n_layer*n_embd*ggml_v2_type_sizef(GGML_V2_TYPE_F32));
ctx_size += 1.5*(n_ctx*n_layer*n_embd*ggml_v2_type_sizef(GGML_V2_TYPE_F32));
...
const size_t buf_size_new = 320u*1024*1024 + 2*(mem_per_token*N);
