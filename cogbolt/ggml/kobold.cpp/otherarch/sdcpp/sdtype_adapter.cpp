...
const int default_res_limit = 8192;
...
img_soft_limit = std::min(hard_megapixel_res_limit * 2, img_soft_limit);
} else {
...
{
if(input_extraimage_buffers.size()>0)
{
