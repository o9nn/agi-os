...
ggml_backend_rpc_buffer_get_base,
...
ggml_backend_rpc_buffer_type_get_alignment,
ggml_backend_rpc_get_max_size,
ggml_backend_rpc_buffer_type_get_alloc_size,
NULL,
};
...
ggml_backend_rpc_name,
ggml_backend_rpc_free,
NULL,
NULL,
NULL,
...
endpoint,
"RPC[" + std::string(endpoint) + "]",
alignment,
max_size
};
ggml_backend_buffer_type_t buft = new ggml_backend_buffer_type {
ggml_backend_rpc_buffer_type_interface,
ggml_backend_rpc_add_device(endpoint),
buft_ctx
};
...
ggml_backend_rpc_device_get_name,
ggml_backend_rpc_device_get_description,
ggml_backend_rpc_device_get_memory,
ggml_backend_rpc_device_get_type,
ggml_backend_rpc_device_get_props,
ggml_backend_rpc_device_init,
ggml_backend_rpc_device_get_buffer_type,
NULL,
NULL,
ggml_backend_rpc_device_supports_op,
ggml_backend_rpc_device_supports_buft,
NULL,
NULL,
NULL,
NULL,
...
ggml_backend_rpc_reg_get_name,
ggml_backend_rpc_reg_get_device_count,
ggml_backend_rpc_reg_get_device,
ggml_backend_rpc_get_proc_address,
};
ggml_backend_reg_t ggml_backend_rpc_reg(void) {
static struct ggml_backend_reg ggml_backend_rpc_reg = {
GGML_BACKEND_API_VERSION,
ggml_backend_rpc_reg_i,
NULL,
};
