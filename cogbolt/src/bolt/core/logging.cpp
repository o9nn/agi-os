...
stream << "\033[31m" << formattedMessage << "\033[0m" << std::endl;
} else if (entry.level == LogLevel::WARN) {
stream << "\033[33m" << formattedMessage << "\033[0m" << std::endl;
} else if (entry.level == LogLevel::DEBUG) {
stream << "\033[36m" << formattedMessage << "\033[0m" << std::endl;
} else {
...
size_t messageSize = formattedMessage.length() + 1;
