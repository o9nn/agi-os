...
auto categoryFilter = std::make_unique<bolt::CategoryFilter>(bolt::LogLevel::INFO);
categoryFilter->setCategoryLevel(bolt::LogCategory::MEMORY, bolt::LogLevel::DEBUG);
categoryFilter->setCategoryLevel(bolt::LogCategory::EDITOR, bolt::LogLevel::ERROR);
