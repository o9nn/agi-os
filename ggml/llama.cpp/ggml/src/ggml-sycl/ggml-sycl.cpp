...
ggml_backend_sycl_buffer_free_buffer,
ggml_backend_sycl_buffer_get_base,
ggml_backend_sycl_buffer_init_tensor,
ggml_backend_sycl_buffer_memset_tensor,
...
ggml_backend_sycl_buffer_type_get_name,
ggml_backend_sycl_buffer_type_alloc_buffer,
ggml_backend_sycl_buffer_type_get_alignment,
ggml_backend_sycl_buffer_type_get_max_size,
ggml_backend_sycl_buffer_type_get_alloc_size,
NULL,
};
...
ggml_backend_sycl_buffer_type_interface,
ggml_backend_reg_dev_get(ggml_backend_sycl_reg(), i),
...
ggml_backend_sycl_split_buffer_get_base,
...
NULL,
ggml_backend_sycl_split_buffer_clear,
NULL,
};
...
ggml_backend_sycl_split_buffer_type_get_name,
...
ggml_backend_sycl_split_buffer_type_is_host,
};
...
scope_op_debug_print scope_dbg_print(__func__, "/to_fp16_sycl", dst, 2,
...
scope_op_debug_print scope_dbg_print(__func__, "/to_fp32_sycl", dst, 2,
...
if (src1->type != GGML_TYPE_F16) {
scope_op_debug_print    scope_dbg_print(__func__, "/to_fp16_nc_sycl", dst, 2,
" : converting src1 to fp16");
int64_t last_dim=0;
int64_t last_str=0;
...
return !g_ggml_sycl_disable_optimize &&
ctx.opt_feature.reorder &&
dst->op == GGML_OP_MUL_MAT &&
dst->src[1]->ne[1]==1 && dst->src[1]->ne[2]==1 && dst->src[1]->ne[3]==1;
}
static void opt_for_reorder(ggml_backend_sycl_context * ctx, const ggml_tensor * src0, const ggml_tensor * ,
...
ggml_backend_sycl_event_record,
ggml_backend_sycl_event_wait,
};
...
ggml_backend_sycl_device_get_name,
ggml_backend_sycl_device_get_description,
ggml_backend_sycl_device_get_memory,
...
ggml_backend_sycl_device_buffer_from_host_ptr,
ggml_backend_sycl_device_supports_op,
ggml_backend_sycl_device_supports_buft,
ggml_backend_sycl_device_offload_op,
ggml_backend_sycl_device_event_new,
ggml_backend_sycl_device_event_free,
...
ggml_backend_sycl_reg_get_device_count,
ggml_backend_sycl_reg_get_device,
ggml_backend_sycl_reg_get_proc_address,
};
...
ggml_backend_sycl_reg_interface,
ctx
};
}
initialized = true;
...
ggml_backend_sycl_guid(),
ggml_backend_sycl_interface,
ggml_backend_reg_dev_get(ggml_backend_sycl_reg(), device),
ctx
};
return sycl_backend;
}
