...
def should_skip_tensor(name: str, has_text: bool, has_vision: bool, has_llava: bool) -> bool:
    if name in ('logit_scale', 'text_model.embeddings.position_ids', 'vision_model.embeddings.position_ids'):
        return True
    if name in ('vision_model.head.probe', 'vision_model.head.attention.in_proj_weight', 'vision_model.head.attention.in_proj_bias', 'vision_model.head.attention.out_proj.weight', 'vision_model.head.attention.out_proj.bias', 'vision_model.head.layernorm.weight', 'vision_model.head.layernorm.bias', 'vision_model.head.mlp.fc1.weight', 'vision_model.head.mlp.fc1.bias', 'vision_model.head.mlp.fc2.weight', 'vision_model.head.mlp.fc2.bias'):
        return True
...
if has_vision_encoder:
    ...
    fout.add_float32(k(KEY_ATTENTION_LAYERNORM_EPS, VISION), 1e-06)
