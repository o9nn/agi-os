...
output.ids = toks.data();
return output;
}
static std::string detokenized_str = "";
...
last_logprob_toppicks = gpttype_get_top_picks_data();
...
size_t calc_old_state_kv(int slot)
{
