...
cl_mem d_D = ggml_v3_cl_pool_malloc(ne00 * ne01 * sizeof(float), &d_size);
...
const int y_ne = ne11 * ne10;
const int d_ne = ne11 * ne01;
const int x_bps = x_ne / ggml_v3_blck_size(type);
...
static bool ggml_v3_cl_mul_mat_use_f16(const struct ggml_v3_tensor * src0, const struct ggml_v3_tensor * src1, struct ggml_v3_tensor * ) {
if (!fp16_support) {
return false;
}
