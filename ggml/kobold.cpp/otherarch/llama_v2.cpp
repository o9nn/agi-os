...
LLAMA_V2_FILE_VERSION_GGMF_V1,
LLAMA_V2_FILE_VERSION_GGJT_V1,
LLAMA_V2_FILE_VERSION_GGJT_V2,
LLAMA_V2_FILE_VERSION_GGJT_V3,
};
...
uint32_t version = 0;
uint32_t magic_ggjt = 0x67676a74u;
uint32_t magic_ggmf = 0x67676d66u;
uint32_t magic_ggml = 0x67676d6cu;
if (magic != magic_ggml) {
...
void write_magic() {
uint32_t magic_ggjt = 0x67676a74u;
file.write_u32(magic_ggjt);
file.write_u32(LLAMA_V2_FILE_VERSION);
}
...
LLAMA_V2_ASSERT(lt.ggml_v2_tensor == NULL);
...
LLAMA_V2_ASSERT(lt.ggml_v2_tensor);
...
uint32_t magic_ggla = 0x67676c61u;
if (magic != magic_ggla) {
