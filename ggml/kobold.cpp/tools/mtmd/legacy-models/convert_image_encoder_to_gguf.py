...
encoder_group.add_argument('--clip-model-is-openclip', action='store_true', required=False, help='The clip model is from openclip (for ViT-SO400M type))')
encoder_group.add_argument('--clip-model-is-siglip', action='store_true', required=False, help='the visual encoder is Siglip.')
