...
class Link(Atom):
    def __init__(self, type: str | None=None, targets: list[str] | None=None, is_toplevel: bool=False, custom_attributes: Properties | None=None, tokens: list[str] | None=None, other=None) -> None:
        if tokens:
            self._targets = []
    ...
    def __eq__(self, other: 'Link') -> bool:
        if not isinstance(other, Link):
            return False
        return self.targets == other.targets and self.type == other.type and (self.is_toplevel == other.is_toplevel) and (self.custom_attributes == other.custom_attributes)
