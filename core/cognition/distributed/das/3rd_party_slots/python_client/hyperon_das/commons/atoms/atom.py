...
class Atom:
    ...
    WILDCARD_STRING = '*'
    def __init__(self, type: str | None=None, is_toplevel: bool=False, custom_attributes: Properties | None=None, other=None) -> None:
        if other:
    ...
    def __eq__(self, other: 'Atom') -> bool:
        if not isinstance(other, Atom):
            return False
        return self.type == other.type and self.is_toplevel == other.is_toplevel and (self.custom_attributes == other.custom_attributes)
