...
class Node(Atom):
    def __init__(self, type: str | None=None, name: str | None=None, is_toplevel: bool=False, custom_attributes: Properties | None=None, tokens: list[str] | None=None, other=None) -> None:
        if tokens:
    ...
    def __eq__(self, other: 'Node') -> bool:
        if not isinstance(other, Node):
            return False
        return self.name == other.name and self.type == other.type and (self.is_toplevel == other.is_toplevel) and (self.custom_attributes == other.custom_attributes)
