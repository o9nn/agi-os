...
class TestQueryAnswer:
    ...
    @pytest.mark.parametrize('token_str', ['', 'badfloat 0.0 1 h1 0', '1.2 badfloat 1 h1 0', '1.1 1.0 badint h1 0', '1.0 1.0 -1', '1.0 1.0 1 h1 bad', '1.0 1.0 1 h1 -1', '1.0 1.0 0 1 extra'])
