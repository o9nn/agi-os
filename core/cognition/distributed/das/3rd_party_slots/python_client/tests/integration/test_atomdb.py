...
def test_atomdb_proxy_simple_client():
    service_bus = ServiceBusSingleton(host_id='0.0.0.0:9001', known_peer='0.0.0.0:40006', port_lower=41200, port_upper=41299).get_instance()
    proxy = AtomDBProxy()
    ...
    atoms_tokens = ['NODE', 'Symbol', 'false', '3', 'is_literal', 'bool', 'false', 'Similarity', 'NODE', 'Symbol', 'false', '3', 'is_literal', 'bool', 'true', '"human"', 'NODE', 'Symbol', 'false', '3', 'is_literal', 'bool', 'true', '"monkey"', 'LINK', 'Expression', 'true', '0', '3', node_handle1, node_handle2, node_handle3]
