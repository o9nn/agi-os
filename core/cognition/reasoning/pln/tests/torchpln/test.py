...
def init_pln():
    ...
    ExecutionLink(SchemaNode('URE:maximum-iterations'), rule_base, NumberNode('100'))
    return rule_base
class TestBasic(unittest.TestCase):
    ...
    def test_fuzzy_conjunction(self):
        ...
        set_ttv(inh_green, torch.tensor([0.96, 0.9]))
    ...
    def test_contraposition(self):
        ...
        self.assertTrue(0 < get_ttv(result).confidence, 'fails due to https://github.com/opencog/opencog/issues/3465')
    def tearDown(self):
        self.atomspace = None
        finalize_opencog()
