...
def modus_ponens_formula(B, AB, A):
    ...
    snotAB = 0.2
    cnotAB = 1
    new_tv = TTruthValue((precise_modus_ponens_strength_formula(sA, sAB, snotAB), min(cAB, cnotAB, cA)))
...
def add_members(rule_base):
    ...
    for f in ('consequent-disjunction-elimination.scm', 'fuzzy-disjunction-introduction.scm', 'modus-ponens.scm', 'contraposition.scm', 'fuzzy-conjunction-introduction.scm'):
