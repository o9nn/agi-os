...
"
 cog-close [STORAGE]
    ...
    STORAGE indicates which connection to close
...
"
  ...
  Load the DAG of AtomSpaces from storage.
    ...
    be created. This will only create the AtomSpaces
...
"
  ...
  Store the DAG of AtomSpaces to storage.
    ...
    will only store the DAG of the AtomSpaces
...
"
 (Predicate \"*-delete-frame-*\") message.
    ...
    The frame is deleted in storage only
...
"
  ...
  Start proxying at the remote end.
    ...
    there is no way to access them directly
