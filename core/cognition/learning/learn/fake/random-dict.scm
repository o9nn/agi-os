...
"
  ...
  If UP is #t, then the string is all upper-case letters
  lower-case.
...
"
  ...
  Zipf exponent for choosing link types
...
"
  ...
  distinct grammatical behaviors
...
"
  ...
  The EXP is the exponent of the Zipfian distribution
