...
#endif
#if BUILD_DISJUNCTS_FREE_INETERMEDIATE_MEMORY
...
{
if (unlikely(NULL == cl->c)) continue;
...
ndis->originating_gword = (gword_set*)gs;
ndis->next = dis;
dis = ndis;
}
return dis;
