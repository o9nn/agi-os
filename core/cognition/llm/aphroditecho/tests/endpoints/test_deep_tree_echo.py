...
class TestDeepTreeEchoEndpoints:
    ...
    def test_dtesn_process_endpoint_enhanced(self, client):
        request_data = {'input_data': 'test input', 'membrane_depth': 3, 'esn_size': 128, 'processing_mode': 'server_side', 'include_intermediate': False, 'output_format': 'json'}
    ...
    def test_batch_process_endpoint(self, client):
        request_data = {'inputs': ['test input 1', 'test input 2', 'test input 3'], 'membrane_depth': 2, 'esn_size': 64, 'parallel_processing': True, 'max_batch_size': 5}
    ...
    def test_stream_process_endpoint(self, client):
        request_data = {'input_data': 'test streaming input', 'membrane_depth': 2, 'esn_size': 64, 'processing_mode': 'streaming'}
