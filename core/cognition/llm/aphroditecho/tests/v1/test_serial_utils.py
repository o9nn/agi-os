...
import pytest
import torch
from aphrodite.multimodal.inputs import MultiModalBatchedField, MultiModalFieldElem, MultiModalKwargs, MultiModalKwargsItem, MultiModalSharedField, NestedTensors
...
def test_multimodal_items_by_modality():
    ...
    e2 = MultiModalFieldElem('video', 'v0', [torch.zeros(1000, dtype=torch.int8) for _ in range(4)], MultiModalBatchedField())
    e3 = MultiModalFieldElem('image', 'i0', torch.zeros(1000, dtype=torch.int32), MultiModalSharedField(4))
    e4 = MultiModalFieldElem('image', 'i1', torch.zeros(1000, dtype=torch.int32), MultiModalBatchedField())
