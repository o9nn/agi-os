...
@pytest.mark.skipif(condition=current_platform.is_cpu(), reason="This test takes a lot time to run on CPU, and aphrodite CI's disk space is not enough for this model.")
