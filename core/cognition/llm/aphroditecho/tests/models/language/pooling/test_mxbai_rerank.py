...
def test_rerank_models_mteb(aphrodite_runner, model_info: RerankModelInfo) -> None:
    ...
    if model_info.architecture == 'Qwen2ForSequenceClassification':
        aphrodite_extra_kwargs['hf_overrides'] = {'architectures': ['Qwen2ForSequenceClassification'], 'classifier_from_token': ['0', '1'], 'method': 'from_2_way_softmax'}
    mteb_test_rerank_models(MxbaiRerankerHfRunner, aphrodite_runner, model_info, aphrodite_extra_kwargs)