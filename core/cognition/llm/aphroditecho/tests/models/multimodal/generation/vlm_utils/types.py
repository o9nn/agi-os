...
class VLMTestInfo(NamedTuple):
    ...
    def get_non_parametrized_runner_kwargs(self):
        return {'enforce_eager': self.enforce_eager, 'max_model_len': self.max_model_len, 'max_num_seqs': self.max_num_seqs, 'runner': self.runner, 'tensor_parallel_size': self.tensor_parallel_size, 'aphrodite_runner_kwargs': self.aphrodite_runner_kwargs, 'hf_output_post_proc': self.hf_output_post_proc, 'aphrodite_output_post_proc': self.aphrodite_output_post_proc, 'auto_cls': self.auto_cls, 'use_tokenizer_eos': self.use_tokenizer_eos, 'comparator': self.comparator, 'get_stop_token_ids': self.get_stop_token_ids, 'hf_model_kwargs': self.hf_model_kwargs, 'stop_str': self.stop_str, 'patch_hf_runner': self.patch_hf_runner}
