...
def aphrodite_reranker(aphrodite_runner: type[AphroditeRunner], model_name: str, dtype: str, query_strs: list[str], document_strs: list[str], query_type: str='text', doc_type: str='text'):
    ...
    with aphrodite_runner(model_name, runner='pooling', dtype=dtype, max_num_seqs=2, max_model_len=2048, mm_processor_kwargs=mm_processor_kwargs, limit_mm_per_prompt=limit_mm_per_prompt) as aphrodite_model:
