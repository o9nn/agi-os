...
def test_multimodal_processor(model_id):
    ...
    str_processed_inputs = mm_processor.apply(prompt=str_prompt, mm_data=mm_data, hf_processor_mm_kwargs={})
    ids_prompt = [151644, 872, 220, 151646, 198, 3838, 374, 279, 2213, 315, 419, 2168, 30, 151645, 151644, 77091, 198]
    ids_processed_inputs = mm_processor.apply(prompt=ids_prompt, mm_data=mm_data, hf_processor_mm_kwargs={})
