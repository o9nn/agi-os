...
def test_processor_override(model_id: str, expected_toks_per_frame: int, expected_grid_t: int, fps: int, num_frames: int):
    ctx = build_model_context(model_id, mm_processor_kwargs=None, limit_mm_per_prompt={'video': 1})
