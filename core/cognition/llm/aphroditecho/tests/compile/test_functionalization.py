...
from aphrodite.compilation.fusion import FUSED_OPS, FusionPass, QuantKey, kFp8DynamicTokenSym, kFp8StaticTensorSym
...
def test_fix_functionalization(model: str, quant_key: QuantKey, do_fusion: bool):
    ...
    aphrodite_config.compilation_config = CompilationConfig(pass_config=CompilationConfig.PassConfig(enable_fusion=do_fusion, enable_noop=True))
