...
def use_v0_only(monkeypatch):
    """
    We should enable this for V1, but APHRODITE_TEST_ENABLE_ARTIFICIAL_PREEMPT,
    so use APHRODITE_USE_V1=0 for all tests in the file.
    """
...
def check_settings():
    assert ENABLE_ARTIFICIAL_PREEMPT is True, (
        ...
        "`APHRODITE_TEST_ENABLE_ARTIFICIAL_PREEMPT=1 "
        "pytest tests/basic_correctness/test_preemption.py`")
