...
def test_encoder_decoder_e2e(hf_runner, aphrodite_runner, example_encoder_decoder_prompts, model: str, dtype: str, max_tokens: int, num_logprobs: int, decoder_prompt_type: DecoderPromptType, enforce_eager: bool, attn_backend: _Backend) -> None:
    with global_force_attn_backend_context_manager(attn_backend):
        ...
        with aphrodite_runner(model, dtype=dtype, enforce_eager=enforce_eager) as aphrodite_model:
            aphrodite_outputs = aphrodite_model.generate_encoder_decoder_greedy_logprobs(test_case_prompts, max_tokens, num_logprobs)
