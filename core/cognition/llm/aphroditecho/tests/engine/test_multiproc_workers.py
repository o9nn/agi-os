...
from aphrodite.executor.multiproc_worker_utils import ProcessWorkerWrapper, ResultHandler, WorkerMonitor
...
def _start_workers() -> tuple[list[ProcessWorkerWrapper], WorkerMonitor]:
    ...
    workers = [ProcessWorkerWrapper(result_handler, DummyWorkerWrapper, aphrodite_config, rank) for rank in range(8)]
