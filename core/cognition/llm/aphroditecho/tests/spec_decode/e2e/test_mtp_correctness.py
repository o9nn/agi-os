...
def test_mtp_e2e_greedy_correctness(aphrodite_runner, common_llm_kwargs,
...
def test_mtp_e2e_greedy_logprobs(aphrodite_runner, common_llm_kwargs,
                                 per_test_common_llm_kwargs,
                                 baseline_llm_kwargs, test_llm_kwargs,
...
@pytest.mark.parametrize("batch_size", [1, 32])
@pytest.mark.parametrize("seed", [1])
def test_mtp_e2e_greedy_correctness_cuda_graph(aphrodite_runner, common_llm_kwargs,
                                               per_test_common_llm_kwargs,
                                               baseline_llm_kwargs,
                                               test_llm_kwargs,
                                               batch_size: int,
...
@pytest.mark.parametrize("seed", [1])
def test_mtp_different_k(aphrodite_runner, common_llm_kwargs,
...
@pytest.mark.parametrize("seed", [1])
def test_mtp_disable_queue(aphrodite_runner, common_llm_kwargs,
                           per_test_common_llm_kwargs, baseline_llm_kwargs,
                           test_llm_kwargs, batch_size: int, output_len: int,
                           seed: int):
    """Verify that mtp speculative decoding produces exact equality
