    ...
    try:
        ...
        for container in containers:
            if container == 'Development':
                custom_settings = {'bookmarks': [{'name': 'GitHub', 'url': 'https://github.com'}, {'name': 'Stack Overflow', 'url': 'https://stackoverflow.com'}, {'name': 'ChatGPT', 'url': 'https://chat.openai.com'}, {'name': 'CodePen', 'url': 'https://codepen.io'}, {'name': 'Dev.to', 'url': 'https://dev.to'}]}
