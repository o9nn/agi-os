...
def test_rendering_hints():
    ...
    compression_hints = RenderingHints.generate_hints({'compressed': True, 'compression_method': 'gzip', 'original_size': 1024})
...
def test_route_optimization_functions():
    ...
    try:
        from aphrodite.endpoints.deep_tree_echo.routes import _get_optimal_chunk_size, _get_compression_level, _estimate_throughput, _get_adaptive_delay
