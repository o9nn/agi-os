...
from test_serialization_simple import MockDTESNResult, OptimizedJSONSerializer, SerializationConfig, SerializationFormat
...
def demo_use_cases():
    ...
    config_api = SerializationConfig(include_engine_integration=False, include_metadata=True)
    ...
    config_debug = SerializationConfig(include_engine_integration=True, include_metadata=True)
