...
def main(is_tool=True):
    ...
    for function in functions:
        ...
        if not description:
            continue
        declarations.append(build_declaration(func_name, description, params, func_args))
    if is_tool:
...
def build_declaration(name: str, description: str, params: dict, args: OrderedDict[str, str]) -> dict[str, dict]:
    declaration = {'name': name, 'description': description, 'parameters': {'type': 'object', 'properties': {}}}
