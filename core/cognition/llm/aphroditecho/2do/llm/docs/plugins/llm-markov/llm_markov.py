...
class Markov(llm.Model):
    ...
    class Options(llm.Options):
        length: Optional[int] = Field(description='Number of words to generate', default=None)
        delay: Optional[float] = Field(description='Seconds to delay between each token', default=None)
