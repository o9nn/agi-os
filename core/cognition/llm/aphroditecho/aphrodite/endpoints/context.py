...
class HarmonyContext(ConversationContext):
    def __init__(self, messages: list, tool_sessions: dict[str, Tool]):
    ...
    def need_builtin_tool_call(self) -> bool:
        ...
        return recipient is not None and (recipient.startswith('browser.') or recipient.startswith('python'))
    async def call_tool(self) -> list[Message]:
    ...
    async def call_search_tool(self, tool_session: Tool, last_msg: Message) -> list[Message]:
        return await tool_session.get_result(self)
    async def call_python_tool(self, tool_session: Tool, last_msg: Message) -> list[Message]:
        return await tool_session.get_result(self)
