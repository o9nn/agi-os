...
from aphrodite.endpoints.openai.protocol import ChatCompletionRequest, CompletionRequest
from aphrodite.engine.args_tools import EngineArgs
from aphrodite.platforms import current_platform
APHRODITE_SUBCMD_PARSER_EPILOG = 'Tip: Use `aphrodite [run|run-batch|bench <bench_type>] --help=<keyword>` to explore arguments from help.\n   - To view a argument group:     --help=ModelConfig\n   - To view a single argument:    --help=max-num-seqs\n   - To search by keyword:         --help=max\n   - To list all groups:           --help=listgroup\n   - To view help with pager:      --help=page'
...
def log_non_default_args(args: Union[argparse.Namespace, EngineArgs]):
    ...
    if isinstance(args, argparse.Namespace):
        ...
        raise TypeError('Unsupported argument type. Must be argparse.Namespace or EngineArgs instance.')
