...
class Qwen3CoderToolParser(ToolParser):
    ...
    def __init__(self, tokenizer: AnyTokenizer):
        ...
        logger.debug("Aphrodite Successfully import tool parser {} !",
        ...
        def convert_param_value(param_value: str, param_name: str,
            ...
            if param_type in [
                ...
                if param_value not in ["true", "false"]:
                    logger.warning(
                        "Parsed value '{}' of parameter '{}' is not a "
                        "boolean (`true` of `false`) in tool '{}', "
                ...
                if param_type == "object" or param_type.startswith("dict"):
                    try:
                        ...
                        logger.warning(
                            "Parsed value '{}' of parameter '{}' is not a "
                            "valid JSON object in tool '{}', will try other "
                ...
                try:
                    ...
                    logger.warning(
                        ...
                        "converted via Python `eval()` in tool '{}', "
