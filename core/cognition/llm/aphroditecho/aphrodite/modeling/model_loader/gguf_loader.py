...
from aphrodite.modeling.model_loader.utils import initialize_model, process_weights_after_loading, set_default_torch_dtype
from aphrodite.modeling.model_loader.weight_utils import get_gguf_extra_tensor_names, gguf_quant_weights_iterator
class GGUFModelLoader(BaseModelLoader):
    ...
    def _prepare_weights(self, model_name_or_path: str):
        ...
        if '/' in model_name_or_path and model_name_or_path.endswith('.gguf'):
            ...
            raise ValueError(f'Unrecognised GGUF reference: {model_name_or_path} (expected local file, raw URL, or <repo_id>/<filename>.gguf)')
