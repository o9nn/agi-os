...
from aphrodite.modeling.models.qwen2_5_vl import Qwen2_5_VisionTransformer, Qwen2_5_VLImageEmbeddingInputs, Qwen2_5_VLImageInputs, Qwen2_5_VLImagePixelInputs, Qwen2_5_VLProcessingInfo, Qwen2_5_VLVideoEmbeddingInputs, Qwen2_5_VLVideoInputs, Qwen2_5_VLVideoPixelInputs
from aphrodite.modeling.models.qwen2_audio import Qwen2AudioInputs, Qwen2AudioProcessingInfo, _get_feat_extract_output_lengths
from aphrodite.modeling.models.qwen2_vl import Qwen2VLMultiModalDataParser
from aphrodite.modeling.sampling_metadata import SamplingMetadata
from aphrodite.multimodal import MULTIMODAL_REGISTRY
from aphrodite.multimodal.inputs import ImageItem, ModalityData, MultiModalDataDict, MultiModalFieldConfig, MultiModalKwargs, NestedTensors
from aphrodite.multimodal.parse import AudioProcessorItems, DictEmbeddingItems, ModalityDataItems, MultiModalDataItems, MultiModalDataParser
from aphrodite.multimodal.processing import BaseMultiModalProcessor, PlaceholderFeaturesInfo, PromptReplacement, PromptUpdate
...
from .utils import AutoWeightsLoader, WeightsMapper, init_aphrodite_registered_model, maybe_prefix, merge_multimodal_embeddings
try:
    import flash_attn
...
class Qwen2_5OmniThinkerProcessingInfo(Qwen2AudioProcessingInfo, Qwen2_5_VLProcessingInfo):
    ...
    def get_hf_processor(self, **kwargs: object) -> Qwen2_5OmniProcessor:
        return self.ctx.get_hf_processor(Qwen2_5OmniProcessor, use_fast=kwargs.pop('use_fast', True), **kwargs)
...
class Qwen2_5OmniThinkerForConditionalGeneration(nn.Module, SupportsMultiModal, SupportsPP, Qwen2_5OmniConditionalGenerationMixin):
    hf_to_aphrodite_mapper = WeightsMapper(orig_to_new_prefix={'thinker.lm_head.': 'language_model.lm_head.', 'thinker.model.': 'language_model.model.', 'thinker.': ''})
    @classmethod
    ...
    def __init__(self, *, aphrodite_config: AphroditeConfig, prefix: str=''):
        ...
        self.language_model = init_aphrodite_registered_model(aphrodite_config=aphrodite_config, prefix=maybe_prefix(prefix, 'language_model'), hf_config=thinker_config.text_config, architectures=['Qwen2ForCausalLM'])
