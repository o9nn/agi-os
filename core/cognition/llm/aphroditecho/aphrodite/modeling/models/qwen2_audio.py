...
from .utils import AutoWeightsLoader, init_aphrodite_registered_model, maybe_prefix, merge_multimodal_embeddings
...
class Qwen2AudioForConditionalGeneration(nn.Module, SupportsMultiModal, SupportsPP):
    ...
    def __init__(self, *, aphrodite_config: AphroditeConfig, prefix: str=''):
        ...
        self.language_model = init_aphrodite_registered_model(aphrodite_config=aphrodite_config, hf_config=config.text_config, prefix=maybe_prefix(prefix, 'language_model'), architectures=['Qwen2ForCausalLM'])
