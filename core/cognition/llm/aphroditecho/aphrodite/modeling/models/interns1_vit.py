...
class InternS1VisionLayer(nn.Module):
    def __init__(self, config: PretrainedConfig, quant_config: Optional[QuantizationConfig]=None, *, num_dummy_heads: int=0, prefix: str='') -> None:
        super().__init__()
        self.attention = self._init_attn(config, quant_config, num_dummy_heads=num_dummy_heads, prefix=f'{prefix}.attention')
...
class InternS1VisionEncoder(nn.Module):
    def __init__(self, config: PretrainedConfig, quant_config: Optional[QuantizationConfig]=None, *, num_hidden_layers_override: Optional[int]=None, num_dummy_heads: int=0, prefix: str=''):
        ...
        self.layer = nn.ModuleList([InternS1VisionLayer(config, quant_config, num_dummy_heads=num_dummy_heads, prefix=f'{prefix}.layer.{layer_idx}') for layer_idx in range(num_hidden_layers)])
...
class InternS1VisionModel(nn.Module):
    def __init__(self, config: PretrainedConfig, quant_config: Optional[QuantizationConfig]=None, *, num_hidden_layers_override: Optional[int]=None, num_dummy_heads: int=0, prefix: str='') -> None:
        ...
        self.encoder = InternS1VisionEncoder(config=config, num_hidden_layers_override=num_hidden_layers_override, num_dummy_heads=num_dummy_heads, prefix=f'{prefix}.encoder')
