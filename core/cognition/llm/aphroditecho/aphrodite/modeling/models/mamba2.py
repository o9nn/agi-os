...
class Mamba2ForCausalLM(nn.Module, HasInnerState, IsAttentionFree):
    ...
    def get_mamba_state_shape_from_config(cls, aphrodite_config: 'AphroditeConfig', use_v1: bool=True) -> tuple[tuple[int, int], tuple[int, int, int]]:
        ...
        return MambaStateShapeCalculator.mamba2_state_shape(intermediate_size=intermediate_size, tp_world_size=parallel_config.tensor_parallel_size, n_groups=hf_config.n_groups, num_heads=hf_config.num_heads, head_dim=hf_config.head_dim, state_size=hf_config.state_size, conv_kernel=hf_config.conv_kernel, use_v1=use_v1)
    def __init__(self, *, aphrodite_config: AphroditeConfig, prefix: str=''):
        config = aphrodite_config.model_config.hf_config
