...
class DbrxRouter(nn.Module):
    def __init__(self, config: PretrainedConfig, params_dtype: Optional[torch.dtype]=None):
        super().__init__()
...
class DbrxExperts(FusedMoE):
    def __init__(self, config: PretrainedConfig, quant_config: Optional[QuantizationConfig]=None, params_dtype: Optional[torch.dtype]=None, prefix: str=''):
