...
class BaiChuanModel(nn.Module):
    def __init__(self, aphrodite_config: AphroditeConfig, prefix: str='', position_embedding: str='ROPE') -> None:
        super().__init__()
...
class BaiChuanBaseForCausalLM(nn.Module, SupportsLoRA, SupportsPP, SupportsQuant):
    ...
    def __init__(self, *, aphrodite_config: AphroditeConfig, prefix: str='', position_embedding: str='ROPE'):
        super().__init__()
        config = aphrodite_config.model_config.hf_config
        quant_config = aphrodite_config.quant_config
        ...
        self.model = BaiChuanModel(aphrodite_config=aphrodite_config, prefix=prefix, position_embedding=position_embedding)
