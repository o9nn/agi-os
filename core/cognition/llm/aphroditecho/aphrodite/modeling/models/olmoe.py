...
from aphrodite.distributed import get_pp_group, get_tensor_model_parallel_rank, get_tensor_model_parallel_world_size, tensor_model_parallel_all_gather
...
class OlmoeForCausalLM(nn.Module, SupportsPP):
    ...
    def __init__(self, *, aphrodite_config: AphroditeConfig, prefix: str=''):
        ...
        self.model = OlmoeModel(aphrodite_config=aphrodite_config, prefix=maybe_prefix(prefix, 'model'))
