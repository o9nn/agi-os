...
class GLM4VForCausalLM(ChatGLMBaseModel, SupportsLoRA, SupportsPP, SupportsMultiModal):
    ...
    def __init__(self, *, aphrodite_config: AphroditeConfig, prefix: str='', transformer_type: type[GLM4VModel]=GLM4VModel) -> None:
    ...
    def _parse_and_validate_image_input(self, **kwargs: object) -> Optional[GLMVImagePixelInputs]:
        ...
        if pixel_values is not None:
            ...
            return GLMVImagePixelInputs(type='pixel_values', data=flatten_bn(pixel_values, concat=True), resolve_bindings={'h': expected_h, 'w': expected_w})
        return None
