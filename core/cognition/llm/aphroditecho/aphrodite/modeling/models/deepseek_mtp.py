...
class DeepSeekMultiTokenPredictor(nn.Module):
    def __init__(self, *, aphrodite_config: AphroditeConfig, prefix: str=''):
        ...
        self.layers = torch.nn.ModuleDict({str(idx): DeepSeekMultiTokenPredictorLayer(config, f'{prefix}.layers.{idx}', model_config=aphrodite_config.model_config, cache_config=aphrodite_config.cache_config, quant_config=aphrodite_config.quant_config) for idx in range(self.mtp_start_layer_idx, self.mtp_start_layer_idx + self.num_mtp_layers)})
...
class DeepSeekMTP(nn.Module, SupportsPP):
    def __init__(self, *, aphrodite_config: AphroditeConfig, prefix: str=''):
        ...
        self.model = DeepSeekMultiTokenPredictor(aphrodite_config=aphrodite_config, prefix=maybe_prefix(prefix, 'model'))
