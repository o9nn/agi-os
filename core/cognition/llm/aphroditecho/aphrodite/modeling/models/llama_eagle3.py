...
class LlamaModel(nn.Module):
    def __init__(self, *, aphrodite_config: AphroditeConfig, start_layer_id: int=0, prefix: str='') -> None:
        super().__init__()
        ...
        self.layers = nn.ModuleList([LlamaDecoderLayer(config=self.config, prefix=maybe_prefix(prefix, f'layers.{start_layer_id}'))])
