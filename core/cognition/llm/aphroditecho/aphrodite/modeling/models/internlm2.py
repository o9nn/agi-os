...
class InternLM2Model(nn.Module):
    def __init__(self, *, aphrodite_config: AphroditeConfig, prefix: str='', layer_type: type[InternLMDecoderLayer]=InternLMDecoderLayer):
        super().__init__()
...
class InternLM2ForCausalLM(nn.Module, SupportsPP, SupportsLoRA):
    ...
    def __init__(self, *, aphrodite_config: AphroditeConfig, prefix: str='', model_type: type[InternLM2Model]=InternLM2Model):
        super().__init__()
        config = aphrodite_config.model_config.hf_config
        quant_config = aphrodite_config.quant_config
