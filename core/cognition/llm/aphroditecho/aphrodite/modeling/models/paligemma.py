...
from aphrodite.multimodal.inputs import MultiModalDataDict, MultiModalFieldConfig, MultiModalInputs, MultiModalKwargs
from aphrodite.multimodal.parse import ImageEmbeddingItems, ImageProcessorItems, MultiModalDataItems
from aphrodite.multimodal.processing import BaseMultiModalProcessor, BaseProcessingInfo, PromptIndexTargets, PromptInsertion, PromptUpdate, PromptUpdateDetails
