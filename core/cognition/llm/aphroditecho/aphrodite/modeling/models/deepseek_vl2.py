...
from aphrodite.transformers_utils.configs.deepseek_vl2 import DeepseekVLV2Config, MlpProjectorConfig, VisionEncoderConfig
...
class DeepseekVLV2ForCausalLM(nn.Module, SupportsMultiModal, SupportsPP):
    hf_to_aphrodite_mapper = WeightsMapper(orig_to_new_prefix={'language.': 'language_model.'})
    @classmethod
    ...
    def __init__(self, *, aphrodite_config: AphroditeConfig, prefix: str=''):
        ...
        self.language_model = init_aphrodite_registered_model(aphrodite_config=aphrodite_config, hf_config=self.text_config, prefix=maybe_prefix(prefix, 'language'), architectures=architectures)
    ...
    def _parse_and_validate_image_input(self, **kwargs: object) -> Optional[DeepseekVL2ImageInputs]:
        ...
        if pixel_values is not None:
            ...
            return DeepseekVL2ImagePixelInputs(type='pixel_values', data=flatten_bn(pixel_values), images_spatial_crop=flatten_bn(images_spatial_crop, concat=True), resolve_bindings={'h': expected_h, 'w': expected_w})
