...
from aphrodite.modeling.layers.linear import ColumnParallelLinear, QKVParallelLinear, ReplicatedLinear, RowParallelLinear
...
class Llama4ForConditionalGeneration(nn.Module, SupportsMultiModal, SupportsPP):
    ...
    def __init__(self, *, aphrodite_config: AphroditeConfig, prefix: str=''):
        ...
        self.use_data_parallel = aphrodite_config.parallel_config.enable_multimodal_encoder_data_parallel
        self.config = config
        ...
        self.language_model = initialize_model(aphrodite_config=aphrodite_config.with_hf_config(config.text_config, ['LlamaForCausalLM']), prefix=maybe_prefix(prefix, 'language_model'), model_class=Llama4ForCausalLM)
