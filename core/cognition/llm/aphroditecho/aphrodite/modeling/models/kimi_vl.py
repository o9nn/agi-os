...
class KimiVLImagePixelInputs(TensorSchema):
    ...
    pixel_values: Annotated[Union[torch.Tensor, list[torch.Tensor]], TensorShape('np', 3, 'ps', 'ps')]
...
class KimiVLForConditionalGeneration(nn.Module, SupportsMultiModal):
    ...
    def __init__(self, aphrodite_config: AphroditeConfig, prefix: str='') -> None:
        ...
        self.language_model = DeepseekV2Model(aphrodite_config=sub_aphrodite_config, prefix=maybe_prefix(prefix, 'language_model'))
