...
from aphrodite.multimodal.processing import BaseProcessingInfo, EncDecMultiModalProcessor, PromptIndexTargets, PromptInsertion, PromptUpdate
...
class Florence2ForConditionalGeneration(nn.Module, SupportsMultiModal, SupportsV0Only):
    ...
    def __init__(self, *, aphrodite_config: AphroditeConfig, prefix: str=''):
        ...
        self.language_model = Florence2LanguageForConditionalGeneration(aphrodite_config=aphrodite_config.with_hf_config(config.text_config), prefix=f'{prefix}.language_model')
    ...
    def _parse_and_validate_image_input(self, **kwargs: object):
        ...
        if pixel_values is not None:
            ...
            return Florence2ImagePixelInputs(type='pixel_values', data=flatten_bn(pixel_values, concat=True), resolve_bindings={'h': expected_h, 'w': expected_w})
