...
from aphrodite.multimodal.parse import DictEmbeddingItems, ImageItem, ImageProcessorItems, ImageSize, ModalityData, ModalityDataItems, MultiModalDataItems, MultiModalDataParser, VideoItem, VideoProcessorItems
...
class MiniCPMVBaseModel(nn.Module, SupportsMultiModal, SupportsPP):
    ...
    def init_llm(self, aphrodite_config: AphroditeConfig, prefix: str='') -> nn.Module:
