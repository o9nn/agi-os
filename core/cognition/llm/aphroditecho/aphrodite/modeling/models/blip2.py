...
from aphrodite.multimodal.processing import BaseMultiModalProcessor, BaseProcessingInfo, PromptIndexTargets, PromptInsertion, PromptUpdate
...
class Blip2ForConditionalGeneration(nn.Module, SupportsMultiModal, SupportsPP, SupportsQuant):
    ...
    def _create_image_input(self, **kwargs: object) -> Optional[Blip2ImageInputs]:
        ...
        if pixel_values is not None:
            ...
            return Blip2ImagePixelInputs(type='pixel_values', data=flatten_bn(pixel_values, concat=True), resolve_bindings={'h': expected_h, 'w': expected_w})
        if image_embeds is not None:
            return Blip2ImageEmbeddingInputs(type='image_embeds', data=flatten_bn(image_embeds, concat=True))
