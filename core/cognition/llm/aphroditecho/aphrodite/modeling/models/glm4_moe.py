...
class Glm4MoE(nn.Module):
    def __init__(self, config: PretrainedConfig, quant_config: Optional[QuantizationConfig]=None, prefix: str='', enable_eplb: bool=False):
        ...
        self.gate = ReplicatedLinear(config.hidden_size, config.n_routed_experts, bias=False, quant_config=None, params_dtype=torch.float32, prefix=f'{prefix}.gate')
...
class Glm4MoeModel(nn.Module):
    ...
    def get_expert_mapping(self) -> list[tuple[str, str, int, str]]:
        return FusedMoE.make_expert_params_mapping(ckpt_gate_proj_name='gate_proj', ckpt_down_proj_name='down_proj', ckpt_up_proj_name='up_proj', num_experts=self.config.n_routed_experts)
