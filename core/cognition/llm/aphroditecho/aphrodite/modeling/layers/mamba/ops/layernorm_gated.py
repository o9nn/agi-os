...
def rms_norm_gated(x, weight, bias, z=None, eps=1e-06, group_size=None, norm_before_gate=True):
    x_shape_og = x.shape
    ...
    y, _, _ = _layer_norm_fwd(x, weight, bias, eps, z=z, group_size=group_size, norm_before_gate=norm_before_gate, is_rms_norm=True)
