...
from aphrodite.modeling.layers.fused_moe.config import FusedMoEQuantConfig, get_config_quant_dtype
from aphrodite.modeling.layers.fused_moe.cutlass_moe import _valid_cutlass_block_scaled_grouped_gemm, run_cutlass_block_scaled_fused_experts
...
from aphrodite.modeling.layers.fused_moe.utils import _resize_cache, moe_kernel_quantize_input, per_token_group_quant_fp8
...
def get_moe_configs(E: int, N: int, dtype: Optional[str], block_n: Optional[int]=None, block_k: Optional[int]=None) -> Optional[dict[int, Any]]:
    ...
    if os.path.exists(config_file_path):
        with open(config_file_path) as f:
            logger.info('Using configuration from {} for MoE layer.', config_file_path)
            return {int(key): val for key, val in json.load(f).items()}
    logger.warning('Using default MoE config. Performance might be sub-optimal! Config file not found at {}', config_file_path)
    return None
...
def try_get_optimal_moe_config(w1_shape: tuple[int, ...], w2_shape: tuple[int, ...], top_k: int, dtype: Optional[str], M: int, is_marlin: bool=False, block_shape: Optional[list[int]]=None) -> dict[str, int]:
    ...
    return config
def aphrodite_topk_softmax(topk_weights: torch.Tensor, topk_indices: torch.Tensor, token_expert_indices: torch.Tensor, gating_output: torch.Tensor, renormalize: bool) -> tuple[torch.Tensor, ...]:
...
def inplace_fused_experts(hidden_states: torch.Tensor, w1: torch.Tensor, w2: torch.Tensor, topk_weights: torch.Tensor, topk_ids: torch.Tensor, activation: str='silu', is_act_and_mul: bool=True, apply_router_weight_on_input: bool=False, use_fp8_w8a8: bool=False, use_int8_w8a8: bool=False, use_int8_w8a16: bool=False, use_int4_w4a16: bool=False, use_mxfp4_w4a4: bool=False, per_channel_quant: bool=False, global_num_experts: int=-1, expert_map: Optional[torch.Tensor]=None, w1_scale: Optional[torch.Tensor]=None, w2_scale: Optional[torch.Tensor]=None, w1_zp: Optional[torch.Tensor]=None, w2_zp: Optional[torch.Tensor]=None, a1_scale: Optional[torch.Tensor]=None, a2_scale: Optional[torch.Tensor]=None, block_shape: Optional[list[int]]=None) -> None:
    fused_experts_impl(hidden_states, w1, w2, topk_weights, topk_ids, True, activation, is_act_and_mul, apply_router_weight_on_input, use_fp8_w8a8, use_int8_w8a8, use_int8_w8a16, use_int4_w4a16, use_mxfp4_w4a4, per_channel_quant, global_num_experts, expert_map, w1_scale, w2_scale, w1_zp, w2_zp, a1_scale, a2_scale, block_shape)
...
def flashinfer_fused_moe_per_tensor_scale_fp8(routing_logits: torch.Tensor, routing_bias: Optional[torch.Tensor], hidden_states: torch.Tensor, input_scale: torch.Tensor, gemm1_weights: torch.Tensor, gemm1_weights_scale: torch.Tensor, activation_scale: torch.Tensor, gemm2_weights: torch.Tensor, gemm2_weights_scale: torch.Tensor, num_experts: int, top_k: int, num_expert_group: Optional[int], topk_group: Optional[int], intermediate_size: int, local_expert_offset: int, local_num_experts: int, use_routing_scales_on_input: bool, routing_method_type: int, routed_scaling_factor: float=1.0) -> torch.Tensor:
    ...
    quant_hidden_states, input_scale = moe_kernel_quantize_input(hidden_states, input_scale, quant_dtype=torch.float8_e4m3fn, per_act_token_quant=False)
...
def flashinfer_fused_moe_per_tensor_scale_fp8_fake(routing_logits: torch.Tensor, routing_bias: torch.Tensor, hidden_states: torch.Tensor, gemm1_weights: torch.Tensor, output1_scales_scalar: torch.Tensor, output1_scales_gate_scalar: torch.Tensor, gemm2_weights: torch.Tensor, output2_scales_scalar: torch.Tensor, num_experts: int, top_k: int, num_expert_group: int, topk_group: int, intermediate_size: int, local_expert_offset: int, local_num_experts: int, routed_scaling_factor: float=1.0, use_routing_scales_on_input: bool=False, tile_tokens_dim: int=8, routing_method_type: int=0) -> torch.Tensor:
    pass
direct_register_custom_op(op_name='flashinfer_fused_moe_per_tensor_scale_fp8', op_func=flashinfer_fused_moe_per_tensor_scale_fp8, mutates_args=['hidden_states'], fake_impl=flashinfer_fused_moe_per_tensor_scale_fp8_fake, tags=(torch.Tag.needs_fixed_stride_order,))
...
def fused_experts(hidden_states: torch.Tensor, w1: torch.Tensor, w2: torch.Tensor, topk_weights: torch.Tensor, topk_ids: torch.Tensor, inplace: bool=False, activation: str='silu', is_act_and_mul: bool=True, apply_router_weight_on_input: bool=False, use_fp8_w8a8: bool=False, use_int8_w8a8: bool=False, use_int8_w8a16: bool=False, use_int4_w4a16: bool=False, use_mxfp4_w4a4: bool=False, per_channel_quant: bool=False, global_num_experts: int=-1, expert_map: Optional[torch.Tensor]=None, w1_scale: Optional[torch.Tensor]=None, w2_scale: Optional[torch.Tensor]=None, w1_zp: Optional[torch.Tensor]=None, w2_zp: Optional[torch.Tensor]=None, a1_scale: Optional[torch.Tensor]=None, a2_scale: Optional[torch.Tensor]=None, block_shape: Optional[list[int]]=None, allow_deep_gemm: bool=False, allow_cutlass_block_scaled_grouped_gemm: bool=False) -> torch.Tensor:
    should_use_deep_gemm = is_blackwell_deep_gemm_used() or _valid_deep_gemm(hidden_states, w1, w2)
    if allow_deep_gemm and use_fp8_w8a8 and should_use_deep_gemm:
        assert apply_router_weight_on_input is False
        assert is_act_and_mul, 'DeepGemm only supports is_act_and_mul=True for now.'
...
def fused_experts_impl(hidden_states: torch.Tensor, w1: torch.Tensor, w2: torch.Tensor, topk_weights: torch.Tensor, topk_ids: torch.Tensor, inplace: bool=False, activation: str='silu', is_act_and_mul: bool=True, apply_router_weight_on_input: bool=False, use_fp8_w8a8: bool=False, use_int8_w8a8: bool=False, use_int8_w8a16: bool=False, use_int4_w4a16: bool=False, use_mxfp4_w4a4: bool=False, per_channel_quant: bool=False, global_num_experts: int=-1, expert_map: Optional[torch.Tensor]=None, w1_scale: Optional[torch.Tensor]=None, w2_scale: Optional[torch.Tensor]=None, w1_zp: Optional[torch.Tensor]=None, w2_zp: Optional[torch.Tensor]=None, a1_scale: Optional[torch.Tensor]=None, a2_scale: Optional[torch.Tensor]=None, block_shape: Optional[list[int]]=None) -> torch.Tensor:
    ...
    for chunk in range(num_tokens // CHUNK_SIZE + 1):
        ...
        if activation == 'silu' and is_act_and_mul:
            ...
            raise ValueError(f'Unsupported FusedMoe activation: {activation}, with is_act_and_mul={is_act_and_mul}.')
