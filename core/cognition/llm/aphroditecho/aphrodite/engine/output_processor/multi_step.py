...
from aphrodite.common.sequence import APHRODITE_INVALID_TOKEN_ID, CompletionSequenceGroupOutput, Sequence, SequenceGroup, SequenceGroupOutput, SequenceOutput, SequenceStatus
from aphrodite.utils import Counter
from aphrodite.engine.output_processor.interfaces import SequenceGroupOutputProcessor
from aphrodite.engine.output_processor.single_step import single_step_process_prompt_logprob
...
class MultiStepOutputProcessor(SequenceGroupOutputProcessor):
    ...
    def process_outputs(self, sequence_group: SequenceGroup, outputs: List[SequenceGroupOutput], is_async: bool=False) -> None:
        ...
        if is_async:
            ...
            valid_samples = [sample for sample in samples if sample.output_token != APHRODITE_INVALID_TOKEN_ID]
            if valid_samples:
