...
from aphrodite.utils import cuda_device_count_stateless, cuda_get_device_properties
...
_USAGE_ENV_VARS_TO_COLLECT = ['APHRODITE_USE_MODELSCOPE', 'APHRODITE_USE_TRITON_FLASH_ATTN', 'APHRODITE_ATTENTION_BACKEND', 'APHRODITE_USE_FLASHINFER_SAMPLER', 'APHRODITE_PP_LAYER_PARTITION', 'APHRODITE_USE_TRITON_AWQ', 'APHRODITE_USE_V1', 'APHRODITE_ENABLE_V1_MULTIPROCESSING']
