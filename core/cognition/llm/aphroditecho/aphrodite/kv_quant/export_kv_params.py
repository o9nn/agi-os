...
import numpy as np
import torch
def _export_sym(key_stats: dict, value_stats: dict, bits: int, out_dir: Union[str, Path], tp: int=1) -> None:
...
def _export_asym(key_stats: dict, value_stats: dict, bits: int, out_dir: Union[str, Path], tp: int=1) -> None:
