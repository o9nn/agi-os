...
class ArenaManager:
    ...
    def create_arena(self, name: str, description: Optional[str]=None, metadata: Optional[Dict[str, Any]]=None) -> ArenaSession:
        arena_id = str(uuid.uuid4())
        arena = ArenaSession(id=arena_id, name=name, description=description, metadata=metadata or {})
    ...
    def get_arena_stats(self) -> Dict[str, Any]:
        ...
        return {'total_arenas': total_arenas, 'state_counts': state_counts}