...
class PhysicalTokenBlock:
    ...
    def __repr__(self) -> str:
        return f'PhysicalTokenBlock(device={self.device}, block_number={self.block_number}, num_hashed_tokens={self.num_hashed_tokens}, ref_count={self.ref_count}, last_accessed={self.last_accessed}, computed={self.computed})'
class BlockTable:
