...
class FlexAttentionMetadataBuilder(AttentionMetadataBuilder[FlexAttentionMetadata]):
    def __init__(self, kv_cache_spec: AttentionSpec, layer_names: list[str], aphrodite_config: AphroditeConfig, device: torch.device):
        ...
        self.num_heads_q = self.model_config.get_num_attention_heads(aphrodite_config.parallel_config)
        self.num_heads_kv = self.model_config.get_num_kv_heads(aphrodite_config.parallel_config)
