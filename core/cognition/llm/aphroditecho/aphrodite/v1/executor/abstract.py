...
from aphrodite.executor.uniproc_executor import ExecutorWithExternalLauncher as ExecutorWithExternalLauncherV0
from aphrodite.executor.uniproc_executor import UniProcExecutor as UniProcExecutorV0
...
class Executor(ExecutorBase):
    ...
    def get_class(aphrodite_config: AphroditeConfig) -> type['Executor']:
        ...
        if isinstance(distributed_executor_backend, type):
            ...
            from aphrodite.v1.executor.ray_distributed_executor import RayDistributedExecutor
