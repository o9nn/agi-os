...
from aphrodite.transformers_utils.detokenizer_utils import AnyTokenizer, convert_prompt_ids_to_tokens, detokenize_incrementally
    ...
    def _protected_step(self, next_token_id: int) -> Optional[str]:
        try:
            ...
            if str(e) != INVALID_PREFIX_ERR_MSG:
                raise e
            logger.warning('Encountered invalid prefix detokenization error for request {}, resetting decode stream.', self.request_id)
