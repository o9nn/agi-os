...
class Nemotron_Nano_VL_Config(PretrainedConfig):
    ...
    is_composition = True
    def __init__(self, vision_config=None, llm_config=None, force_image_size=None, downsample_ratio=0.5, template=None, ps_version='v1', image_tag_type='internvl', projector_hidden_size=4096, vit_hidden_size=1280, **kwargs):
