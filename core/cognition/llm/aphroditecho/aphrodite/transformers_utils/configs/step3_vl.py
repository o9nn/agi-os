...
class Step3VisionEncoderConfig(PretrainedConfig):
    ...
    def __init__(self, hidden_size=1792, intermediate_size=3072, output_hidden_size=4096, num_hidden_layers=63, num_attention_heads=16, num_channels=3, image_size=728, patch_size=14, hidden_act='quick_gelu', layer_norm_eps=1e-05, **kwargs):
...
class Step3VLConfig(PretrainedConfig):
    model_type = 'step3_vl'
    def __init__(self, vision_config: Optional[Union[dict, Step3VisionEncoderConfig]]=None, text_config: Optional[Union[dict, Step3TextConfig]]=None, understand_projector_stride: int=1, projector_bias: bool=True, image_token_id: int=128001, **kwargs) -> None:
