...
class DbrxAttentionConfig(PretrainedConfig):
    ...
    def from_pretrained(cls, pretrained_model_name_or_path: str, **kwargs: Any) -> 'PretrainedConfig':
        ...
        if 'model_type' in config_dict and hasattr(cls, 'model_type') and (config_dict['model_type'] != cls.model_type):
            logger.warning('You are using a model of type {} to instantiate a model of type {}. This is not supported for all configurations of models and can yield errors.', config_dict['model_type'], cls.model_type)
