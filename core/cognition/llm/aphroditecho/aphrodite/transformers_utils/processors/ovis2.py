...
class OvisProcessor(ProcessorMixin):
    ...
    def __init__(self, image_processor=None, tokenizer=None, chat_template=None, image_pad_token=None, **kwargs):
        ...
        self.extra_special_tokens = {'image_token': -200, 'image_atom': -300, 'image_start': -301, 'image_prefix': -302, 'image_col_sep': -303, 'image_row_sep': -304, 'image_end': -305, 'image_pad': self.image_pad_token_id}
