...
from aphrodite.prompt_adapter.layers import VocabParallelEmbeddingWithPromptAdapter
...
class PromptAdapterModelManager(AdapterModelManager):
    ...
    def activate_adapter(self, prompt_adapter_id: int) -> bool:
        ...
        logger.debug('Activating prompt_adapter. int id: {}, slot index: {}', prompt_adapter_model.id, index)
