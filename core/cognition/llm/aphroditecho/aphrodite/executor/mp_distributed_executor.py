...
from aphrodite.utils import _run_task_with_lock, cuda_device_count_stateless, get_distributed_init_method, get_ip, get_open_port, make_async, run_method, update_environment_variables
from aphrodite.executor.executor_base import DistributedExecutorBase
from aphrodite.executor.multiproc_worker_utils import ProcessWorkerWrapper, ResultHandler, WorkerMonitor, set_multiprocessing_worker_envs
    ...
    def _init_executor(self) -> None:
        ...
        if world_size == 1:
            ...
            for rank in range(1, world_size):
                worker = ProcessWorkerWrapper(result_handler, WorkerWrapperBase, self.aphrodite_config, rank)
