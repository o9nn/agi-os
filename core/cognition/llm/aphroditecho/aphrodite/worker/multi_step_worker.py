...
from aphrodite.worker.multi_step_model_runner import MultiStepModelRunner, StatefulModelInput
...
class MultiStepWorker(Worker):
    def __init__(self, *args, **kwargs):
        ...
        self.model_runner = MultiStepModelRunner(base_model_runner, aphrodite_config=base_model_runner.aphrodite_config, kv_cache_dtype=self.cache_config.cache_dtype, is_driver_worker=base_model_runner.is_driver_worker)
