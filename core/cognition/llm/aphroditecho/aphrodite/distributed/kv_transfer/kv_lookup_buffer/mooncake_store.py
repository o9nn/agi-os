...
from aphrodite.distributed.kv_transfer.kv_lookup_buffer.base import KVStoreBufferBase
...
class MooncakeStore(KVStoreBufferBase):
    def __init__(self, config: AphroditeConfig):
        ...
        try:
            ...
            logger.error('An error occurred while loading the configuration: {}', exc)
            raise
    def close(self):
        pass
