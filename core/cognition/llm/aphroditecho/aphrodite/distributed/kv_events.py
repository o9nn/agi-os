...
class ZmqEventPublisher(EventPublisher):
    ...
    def __init__(self, data_parallel_rank: int=0, endpoint: str='tcp://*:5557', replay_endpoint: Optional[str]=None, buffer_steps: int=10000, hwm: int=100000, max_queue_size: int=100000, topic: str='') -> None:
    ...
    def shutdown(self) -> None:
        ...
        while pending_items and time.time() - start < self.SHUTDOWN_TIMEOUT:
            ...
            if pending_items:
                time.sleep(0.1)
        if pending_items:
            logger.warning('Warning: Queue still has {} items after {} seconds timeout', self._event_queue.qsize(), self.SHUTDOWN_TIMEOUT)
