...
from aphrodite.distributed.device_communicators.custom_all_reduce_utils import gpu_p2p_access_check
...
class CustomAllreduce:
    ...
    def __init__(self, group: ProcessGroup, device: Union[int, str, torch.device], max_size=8192 * 1024) -> None:
        ...
        if world_size not in CustomAllreduce._SUPPORTED_WORLD_SIZES:
            logger.warning('Custom allreduce is disabled due to an unsupported world size: {}. Supported world sizes: {}. To silence this warning, specify disable_custom_all_reduce=True explicitly.', world_size, str(CustomAllreduce._SUPPORTED_WORLD_SIZES))
            return
