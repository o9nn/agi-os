...
const qk_vec_type* __restrict__ q_vecs,
const qk_vec_type* __restrict__ k_vecs,
const vec_op::FP32Vec16* __restrict v_vecs_f32,
...
float logits[BLOCK_SIZE][HEAD_UNROLL] = {};
