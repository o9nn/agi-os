...
SCALAR_TYPES = ['aphrodite::kU4', 'aphrodite::kU4B8', 'aphrodite::kU8B128', 'aphrodite::kFE4M3fn', 'aphrodite::kFE2M1f']
...
def generate_new_kernels():
    for scalar_type, dtype in itertools.product(SCALAR_TYPES, DTYPES):
        ...
        for group_blocks, m_blocks, thread_configs in itertools.product(GROUP_BLOCKS, THREAD_M_BLOCKS, THREAD_CONFIGS):
            if group_blocks == 0 and scalar_type not in ['aphrodite::kU4B8', 'aphrodite::kU8B128']:
                continue
