...
DTYPE_MAP = {'fp16': 'nv_half', 'bf16': 'nv_bfloat16', 'fp32': 'float'}
    ...
    for output_dtype in DTYPES:
        for weight_dtype in DTYPES:
            if weight_dtype == 'fp32':
                continue
            kernel_definition = TEMPLATE.format(input_dtype=DTYPE_MAP[input_dtype], output_dtype=DTYPE_MAP[output_dtype], weight_dtype=DTYPE_MAP[weight_dtype])
