...
def test_hierarchical_simple():
    ...
    goal = MotorGoal(goal_id='simple_reach', goal_type=MotorGoalType.REACH_POSITION, target_data={'target_position': (0.3, 0.1, 1.0), 'end_effector': 'right_elbow', 'duration': 1.5}, priority=1.0)
