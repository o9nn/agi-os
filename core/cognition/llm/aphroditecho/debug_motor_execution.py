from aar_core.embodied import EmbodiedAgent, HierarchicalMotorController, MidLevelTrajectoryGenerator
def debug_trajectory_generation():
    ...
    objective = {'type': 'reach', 'joint_targets': {'right_shoulder': 0.3, 'right_elbow': -0.5}, 'duration': 1.5, 'priority': 0.8, 'coordination_groups': [['right_shoulder', 'right_elbow']]}
...
def debug_motor_executor():
    ...
    manual_trajectory = Trajectory(trajectory_id='manual_test', joint_trajectories={'right_shoulder': shoulder_traj, 'right_elbow': elbow_traj}, total_duration=duration)
