...
def benchmark_function_registry() -> Dict[str, Any]:
    ...
    registry.register(test_function_1, name='test.add', description='Add two integers', params_schema={'type': 'object', 'properties': {'a': {'type': 'integer'}, 'b': {'type': 'integer'}}, 'required': ['a', 'b']}, safety_class='low', cost_unit=0.1, tags=['math'])
    registry.register(test_function_2, name='test.upper', description='Convert text to uppercase', params_schema={'type': 'object', 'properties': {'text': {'type': 'string'}}, 'required': ['text']}, safety_class='low', cost_unit=0.05, tags=['text'])
    registry.register(test_function_3, name='test.process', description='Process data dictionary', params_schema={'type': 'object', 'properties': {'data': {'type': 'object'}}, 'required': ['data']}, safety_class='low', cost_unit=0.2, tags=['data'])
