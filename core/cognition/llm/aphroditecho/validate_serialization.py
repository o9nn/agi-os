...
def main():
    ...
    print('=' * 50)
    print()
    tests = [('Basic Serialization', test_basic_serialization), ('Overhead Reduction', test_overhead_reduction), ('Deterministic Serialization', test_deterministic_serialization), ('Binary Serialization', test_binary_serialization), ('Convenience Functions', test_convenience_functions)]
    passed = 0
    total = len(tests)
