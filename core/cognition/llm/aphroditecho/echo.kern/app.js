class DeepTreeEcho {
    ...
    handleNodeClick(event) {
        const node = event.currentTarget;
        const conceptName = node.getAttribute('data-concept');
        console.log('Node clicked:', conceptName); 
    ...
    showConceptDisplay(concept) {
        ...
        console.log('Showing concept:', concept); 
    ...
    addUserEcho() {
        ...
        if (!text) return;
        console.log('Adding user echo:', text); 
    ...
    handleUserEchoClick(event) {
        ...
        console.log('User echo clicked:', text); 
...
document.addEventListener('DOMContentLoaded', () => {
    console.log('Initializing Deep Tree Echo...'); 
    new DeepTreeEcho();
});
