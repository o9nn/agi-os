...
size_t bytes_per_update = reservoir->config.reservoir_size * sizeof(float) * 3;
...
reservoir->config.reservoir_size * sizeof(float) * 2 +
reservoir->config.input_size * sizeof(float) +
reservoir->config.output_size * sizeof(float) +
sizeof(uint64_t) * 3;
