...
{"B-Series Computation", DTESN_COMPONENT_BSERIES, 80000, 100000, true},
{"ESN State Update", DTESN_COMPONENT_ESN, 800000, 1000000, true},
{"Context Switch", DTESN_COMPONENT_SCHEDULER, 4000, 5000, true},
{"Integrated Pipeline", DTESN_COMPONENT_COUNT, 1500000, 2000000, true},
};
