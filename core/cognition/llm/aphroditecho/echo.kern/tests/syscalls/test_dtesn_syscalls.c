...
TEST_ASSERT(evolution_time <= 100000000ULL,
...
TEST_ASSERT(avg_time <= 1000000,
"Average syscall time should be reasonable");
TEST_ASSERT(max_time <= 10000000,
