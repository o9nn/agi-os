...
float temperatureSampler_temperature = 0.0f;
llama_sampler * greedySampler = nullptr;
llama_sampler * minPSampler = nullptr;
float minPSampler_minP = 0.0f;
...
float repeatPenalty_penalty = 1.10f;
float repeatPenalty_presencePenalty = 0.00f;
float repeatPenalty_frequencyPenalty = 0.00f;
