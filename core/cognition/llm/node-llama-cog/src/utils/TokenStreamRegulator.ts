...
private readonly _queue: QueuedTokenRelease[] = [];
private readonly _LastTokens: Token[] = [];
...
private readonly _textLocks = new Set<QueuedTokenReleaseLock>();
private readonly _tokenLocks = new Set<QueuedTokenReleaseLock>();
...
private readonly _locks: Set<QueuedTokenReleaseLock>;
