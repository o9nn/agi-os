...
private _awaitingDisposeLockCallbacks: (() => void)[] = [];
private _disposeActivated: boolean = false;
private _parentDisposeGuardsLocks: Map<DisposeGuard, DisposalPreventionHandle | null> = new Map();
