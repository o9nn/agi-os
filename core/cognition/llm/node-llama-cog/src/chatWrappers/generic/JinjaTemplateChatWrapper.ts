...
export class JinjaTemplateChatWrapper extends ChatWrapper {
    ...
    public readonly additionalRenderParameters?: Record<string, any>;
     ...
     private readonly _usingJinjaFunctionCallTemplate: boolean = false;
     private readonly _stringifyFunctionParams: boolean = false;
     private readonly _stringifyFunctionResult: boolean = false;
     private readonly _combineJinjaModelMessageAndToolCalls: boolean = true;
     private readonly _endJinjaMessagesWithUserMessage: boolean = false;
