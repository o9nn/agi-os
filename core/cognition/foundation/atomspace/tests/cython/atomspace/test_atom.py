...
class AtomTest(TestCase):
    ...
    def test_grounded_cond(self):
        grounded_cond = CondLink(Evaluation(GroundedPredicate('py:grounded_cond1'), ListLink()), Number('1'), Evaluation(GroundedPredicate('py:grounded_cond2'), ListLink()), Number('2'))
