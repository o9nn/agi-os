...
class TestExceptions(unittest.TestCase):
    ...
    def test_good_evaluation(self):
        atom1 = Concept('atom1')
        eval_link = Evaluation(GroundedPredicate('py:good_tv'), atom1, atom1, atom1)
    ...
    def test_bogus_evaluation(self):
        atom1 = Concept('atom1')
        eval_link = Evaluation(GroundedPredicate('py:foobar'), atom1, atom1, atom1)
        try:
    ...
    def test_pass_evaluation(self):
        atom1 = Concept('atom1')
        eval_link = Evaluation(GroundedPredicate('py:no_ret'), atom1, atom1, atom1)
        try:
            evaluate_atom(self.space, eval_link)
            self.assertFalse('call should fail')
        except RuntimeError as e:
    ...
    def test_num_evaluation(self):
        atom1 = Concept('atom1')
        eval_link = Evaluation(GroundedPredicate('py:ret_num'), atom1, atom1, atom1)
        try:
            evaluate_atom(self.space, eval_link)
            self.assertFalse('call should fail')
        except RuntimeError as e:
    ...
    def test_str_evaluation(self):
        atom1 = Concept('atom1')
        eval_link = Evaluation(GroundedPredicate('py:ret_str'), atom1, atom1, atom1)
        try:
            evaluate_atom(self.space, eval_link)
            self.assertFalse('call should fail')
        except RuntimeError as e:
    ...
    def test_nil_evaluation(self):
        atom1 = Concept('atom1')
        eval_link = Evaluation(GroundedPredicate('py:ret_nil'), atom1, atom1, atom1)
        try:
            evaluate_atom(self.space, eval_link)
            self.assertFalse('call should fail')
        except RuntimeError as e:
    ...
    def test_lst_evaluation(self):
        atom1 = Concept('atom1')
        eval_link = Evaluation(GroundedPredicate('py:ret_lst'), atom1, atom1, atom1)
        try:
            evaluate_atom(self.space, eval_link)
            self.assertFalse('call should fail')
        except RuntimeError as e:
    ...
    def test_good_execution(self):
        atom1 = Concept('atom1')
        exec_link = ExecutionOutput(GroundedSchema('py:good_tv'), ListLink(atom1, atom1, atom1))
    ...
    def test_bogus_execution(self):
        atom1 = Concept('atom1')
        exec_link = ExecutionOutput(GroundedSchema('py:foobar'), ListLink(atom1, atom1, atom1))
        try:
    ...
    def test_pass_execution(self):
        atom1 = Concept('atom1')
        exec_link = ExecutionOutput(GroundedSchema('py:no_ret'), ListLink(atom1, atom1, atom1))
        try:
            self.space.execute(exec_link)
            self.assertFalse('call should fail')
        except RuntimeError as e:
    ...
    def test_num_execution(self):
        atom1 = Concept('atom1')
        exec_link = ExecutionOutput(GroundedSchema('py:ret_num'), ListLink(atom1, atom1, atom1))
        try:
            self.space.execute(exec_link)
            self.assertFalse('call should fail')
        except RuntimeError as e:
    ...
    def test_str_execution(self):
        atom1 = Concept('atom1')
        exec_link = ExecutionOutput(GroundedSchema('py:ret_str'), ListLink(atom1, atom1, atom1))
        try:
            self.space.execute(exec_link)
            self.assertFalse('call should fail')
        except RuntimeError as e:
    ...
    def test_nil_execution(self):
        atom1 = Concept('atom1')
        exec_link = ExecutionOutput(GroundedSchema('py:ret_nil'), ListLink(atom1, atom1, atom1))
        try:
            self.space.execute(exec_link)
            self.assertFalse('call should fail')
        except RuntimeError as e:
    ...
    def test_lst_execution(self):
        atom1 = Concept('atom1')
        exec_link = ExecutionOutput(GroundedSchema('py:ret_lst'), ListLink(atom1, atom1, atom1))
        try:
            self.space.execute(exec_link)
            self.assertFalse('call should fail')
        except RuntimeError as e:
