...
(define-public (clear)
"
  clear -- extract all atoms in the atomspace. Deprecated
...
"
  ...
  The argument ATOMSPACE is optional
  is used.
  See also:
...
"
  ...
  need not occur in the first position in the link
  anywhere.
"
	(let ((lst '()))
		(define (mklist inst)
...
"
 cog-push-atomspace -- Create a temporary AtomSpace.
    ...
    The stack of AtomSpaces is per-thread
