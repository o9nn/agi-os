...
predicate is useful for creating sorted lists of atoms
...
set. The Values hanging off the atoms are NOT compared
differ.
Example:
...
immediate subtypes are returned
...
The ATOMSPACE argument is optional
...
Return #t if ATOMSPACE is an atomspace
")
...
will be used to index the reference
by name.
