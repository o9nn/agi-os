...
#define ROSE_DEFAULT_T0			(180 * HZ)
#define ROSE_DEFAULT_T1			(200 * HZ)
#define ROSE_DEFAULT_T2			(180 * HZ)
#define	ROSE_DEFAULT_T3			(180 * HZ)
#define	ROSE_DEFAULT_HB			(5 * HZ)
#define	ROSE_DEFAULT_IDLE		(0 * 60 * HZ)
#define	ROSE_DEFAULT_ROUTING		1
#define	ROSE_DEFAULT_FAIL_TIMEOUT	(120 * HZ)
