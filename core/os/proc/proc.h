...
struct proc *p_gnext, **p_gprevp;
hurd_ihash_locp_t p_pidhashloc;
hurd_ihash_locp_t p_taskhashloc;
task_t p_task;
pid_t p_pid;
struct login *p_login;
struct ids *p_id;
struct proc *p_parent;
struct proc *p_ochild;
struct proc *p_sib, **p_prevsib;
struct pgrp *p_pgrp;
mach_port_t p_task_namespace;
mach_port_t p_msgport;
pthread_cond_t p_wakeup;
char *exe;
vm_address_t p_argv, p_envp;
vm_address_t start_code;
vm_address_t end_code;
vm_address_t p_entry;
int p_status;
int p_sigcode;
struct rusage p_rusage;
struct rusage p_child_rusage;
unsigned int p_exec:1;
unsigned int p_stopped:1;
unsigned int p_waited:1;
unsigned int p_exiting:1;
unsigned int p_waiting:1;
unsigned int p_traced:1;
unsigned int p_nostopcld:1;
unsigned int p_parentset:1;
unsigned int p_deadmsg:1;
unsigned int p_checkmsghangs:1;
unsigned int p_msgportwait:1;
unsigned int p_loginleader:1;
unsigned int p_dead:1;
unsigned int p_important:1;
unsigned int p_continued:1;
};
typedef struct proc *pstruct_t;
struct pgrp
{
hurd_ihash_locp_t pg_hashloc;
struct proc *pg_plist;
struct pgrp *pg_next, **pg_prevp;
pid_t pg_pgid;
...
extern struct proc *self_proc;
extern struct proc *init_proc;
extern struct proc *startup_proc;
...
extern mach_port_t generic_port;
extern struct proc *kernel_proc;
extern pthread_mutex_t global_lock;
extern int startup_fallback;
