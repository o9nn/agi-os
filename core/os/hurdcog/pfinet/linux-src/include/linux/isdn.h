...
#define ISDN_TIMER_RES         3
#define ISDN_TIMER_02SEC       (HZ/(ISDN_TIMER_RES+1)/5)
#define ISDN_TIMER_1SEC        (HZ/(ISDN_TIMER_RES+1))
...
#define ISDN_TIMER_KEEPALIVE 128
...
struct sk_buff *volatile sav_skb;
int                    (*org_hhc)(
...
u_char       profile[ISDN_MODEM_ANZREG];
u_char       mdmreg[ISDN_MODEM_ANZREG];
...
struct wait_queue  **rcv_waitq;
struct wait_queue  **snd_waitq;
