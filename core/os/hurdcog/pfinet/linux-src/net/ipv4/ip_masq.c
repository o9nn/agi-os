...
{{mSR, mES, mES, mSR, mSR, mSR, mSR, mSR, mSR, mSR }},
{{mCL, mCW, mSS, mTW, mTW, mTW, mCL, mCW, mLA, mLI }},
{{mCL, mES, mSS, mSR, mFW, mTW, mCL, mCW, mCL, mLI }},
{{mCL, mCL, mCL, mSR, mCL, mCL, mCL, mCL, mLA, mLI }},
{{mSS, mES, mSS, mES, mSS, mSS, mSS, mSS, mSS, mLI }},
{{mTW, mFW, mSS, mTW, mFW, mTW, mCL, mTW, mLA, mLI }},
{{mES, mES, mSS, mSR, mFW, mTW, mCL, mCW, mLA, mES }},
{{mCL, mCL, mSS, mCL, mCL, mTW, mCL, mCL, mCL, mCL }},
};
...
ATOMIC_INIT((PORT_MASQ_END-PORT_MASQ_BEGIN) * PORT_MASQ_MUL),
ATOMIC_INIT((PORT_MASQ_END-PORT_MASQ_BEGIN) * PORT_MASQ_MUL),
ATOMIC_INIT((PORT_MASQ_END-PORT_MASQ_BEGIN) * PORT_MASQ_MUL),
};
...
if (ms->flags & IP_MASQ_F_NO_DADDR ) {
write_lock(&__ip_masq_lock);
ip_masq_unhash(ms);
ms->flags &= ~IP_MASQ_F_NO_DADDR;
ms->daddr = iph->saddr;
