...
span = 32*1024;
break;
case (0x0502<<17)|0x100B:
case (0x5229<<16)|0x10B9:
case (0x5288<<16)|0x10B9:
case (0x5513<<16)|0x1039:
case (0x0646<<16)|0x1095:
case (0x0571<<16)|0x1106:
case (0x2363<<16)|0x197b:
break;
...
case (0x24D1<<16)|0x8086:
case (0x24DB<<16)|0x8086:
case (0x25A3<<16)|0x8086:
case (0x2653<<16)|0x8086:
case (0x266F<<16)|0x8086:
case (0x27DF<<16)|0x8086:
case (0x27C0<<16)|0x8086:
case (0x27C5<<16)|0x8086:
case (0x2920<<16)|0x8086:
case (0x3a20<<16)|0x8086:
case (0x3a26<<16)|0x8086:
irqack = ichirqack;
break;
}
