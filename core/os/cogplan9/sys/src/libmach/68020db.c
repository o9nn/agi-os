...
Abs|Bdisp|Pinc|Ind,
Abs|Bdisp|Pdec|Ind,
Abs|Bdisp|Pdec|Pinc|Ind,
Abs|Bdisp|Pdec|Pinc|Ind|Dn,
Abs|Bdisp|Pdec|Pinc|Ind|An|Dn,
Abs|PCrel|Bdisp|Ind,
Abs|PCrel|Bdisp|Pinc|Ind,
Abs|PCrel|Bdisp|Ind|Dn,
Abs|PCrel|Bdisp|Pdec|Pinc|Ind|Dn,
Abs|Imm|PCrel|Bdisp|Pdec|Pinc|Ind,
Abs|Imm|PCrel|Bdisp|Pdec|Pinc|Ind,
Abs|Imm|PCrel|Bdisp|Pdec|Pinc|Ind|Dn,
Abs|Imm|PCrel|Bdisp|Pdec|Pinc|Ind|Dn,
Abs|Imm|PCrel|Bdisp|Pdec|Pinc|Ind|Dn,
Abs|Imm|PCrel|Bdisp|Pdec|Pinc|Ind|An|Dn,
Abs|Imm|PCrel|Bdisp|Pdec|Pinc|Ind|An|Dn,
Abs|Imm|PCrel|Bdisp|Pdec|Pinc|Ind|An|Dn,
Abs|Imm|PCrel|Bdisp|Pdec|Pinc|Ind|An|Dn,
};
