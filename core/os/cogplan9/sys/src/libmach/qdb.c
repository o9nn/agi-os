...
{31, 489, OEM, "DIVD%V%C", qdiv, ir3},
{31, 457, OEM, "DIVDU%V%C", qdiv, ir3},
...
case 0: case 1:
i->mb = i->xmbe; i->me = 63; break;
case 2: case 3:
i->mb = 0; i->me = i->xmbe; break;
case 6: case 7:
i->mb = i->xmbe; i->me = 63-i->xsh; break;
}
