...
static struct file *file = &dfltfile;
static int nfile = 1;
static char *currcolor = BLACK;
...
static int onlimb;
static int poles;
static double orientation[3] = { 90., 0., 0. };
static oriented;
static upright;
static int delta = 1;
static double limits[4] = {
-90., 90., -180., 180.
};
static double klimits[4] = {
-90., 90., -180., 180.
};
static int limcase;
static double rlimits[4];
static double lolat, hilat, lolon, hilon;
static double window[4] = {
-90., 90., -180., 180.
};
static windowed;
static struct vert { double x, y; } v[NVERT+2];
static struct edge { double a, b, c; } e[NVERT];
static int nvert;
static double rwindow[4];
...
static int longlines = SHORTLINES;
...
static struct coord crot;
static double grid[3] = { 10., 10., RESOL };
