...
"#define CS_ID		(1 + (int) (j1_spin & (CS_N-1))) ",
"#define QLOCK(n)	(1+n)",
"#else",
...
"volatile unsigned int	*search_terminated; ",
"#endif",
"void",
"pan_exit(int val)",
...
"				}",
"",
"		ntrpt->ostate = (struct H_el *) otrpt;",
"				ntrpt->st = tt;",
"				if (boq == -1 && (t->atom&2))	",
"					ntrpt->tau = 8;	",
"				else",
...
"		#ifndef NOFAIR",
"#if 0",
"			if (!fairness || ((now._a_t&1) && now._cnt[1] == 1)) ",
"#else",
...
"#endif",
"#ifdef MEMLIM",
"	memlim = ((double) MEMLIM) * (double) (1<<20);	",
"#endif",
"#ifndef BITSTATE",
...
"#ifdef FULLSTACK",
"#ifndef MA",
"	struct H_el *sv = trpt->ostate; ",
"#else",
"	uchar prov = trpt->proviso; ",
"#endif",
"#endif",
"#ifdef DEBUG",
...
"		tmp->ctx_pid[(now._last)/8] = 1 << ((now._last)%8); ",
"	#ifdef CHECK",
"		#if NCORE>1",
"		printf(\"cpu%%d: \", core_id);",
"		#endif",
