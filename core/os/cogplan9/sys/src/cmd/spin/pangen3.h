...
"	#else",
"		#define VECTORSZ	4112	",
"	#endif",
"#else",
"	#ifndef VECTORSZ",
"		#define VECTORSZ	1024	",
"	#endif",
"#endif\n",
0,
};
...
"	x -= j;",
"	if (z) return (long) (x - z);",
"	return ordinal(scratch, x-scratch, 1); ",
"}",
"	#endif",
"#endif",
0,
