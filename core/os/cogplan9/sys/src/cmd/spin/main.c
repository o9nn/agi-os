...
{ if (stat("/bin/gcc-4.exe", (struct stat *)&x) == 0
...
#if 0
case 'x': split_decl = 0; break;
#endif
case 'X': xspin = notabs = 1;
#ifndef PC
signal(SIGPIPE, alldone);
#endif
break;
case 'Y': limited_vis = 1; break;
case 'Z': preprocessonly = 1; break;
default : usage(); break;
}
argc--; argv++;
}
