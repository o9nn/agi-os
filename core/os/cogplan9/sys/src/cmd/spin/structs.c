...
void
setutype(Lextok *p, Symbol *t, Lextok *vis)
{ int oln = lineno;
Symbol *ofn = Fname;
Lextok *m, *n;
m = getuname(t);
...
if (!n->rgt || !n->rgt->lft)
{ non_fatal("no subfields %s", v->name);
...
int
Rval_struct(Lextok *n, Symbol *v, int xinit)
{ Symbol *tl;
Lextok *tmp;
int ix;
...
int
Lval_struct(Lextok *n, Symbol *v, int xinit, int a)
{ Symbol *tl;
Lextok *tmp;
int ix;
