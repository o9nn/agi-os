...
"srinc_set(int n)",
"{	if (n <= 2) return LOCAL;",
"	if (n <= 2+  DELTA) return Q_FULL_F; ",
"	if (n <= 2+2*DELTA) return Q_EMPT_F; ",
"	if (n <= 2+3*DELTA) return Q_EMPT_T; ",
"	if (n <= 2+4*DELTA) return Q_FULL_T; ",
