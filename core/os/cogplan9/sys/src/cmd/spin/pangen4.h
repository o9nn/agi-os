...
"",
"extern char	*emalloc(unsigned long);	",
"extern void	dfa_init(ushort);	",
...
"	struct	Vertex	*dst[2];",
"	struct	Edge	*Succ;	",
"	struct	Vertex	*lnk, *left, *right; ",
"} Vertex;",
"",
"static Edge	*free_edges;",
"static Vertex	*free_vertices;",
"static Vertex	**layers;	",
"static Vertex	**path;		",
"static Vertex	*R, *F, *NF;	",
"static uchar	*word, *lastword;",
"static int	dfa_depth, iv=0, nv=0, pfrst=0, Tally;",
"",
"static void	insert_it(Vertex *, int);	",
...
"",
"static void",
"setDelta(Vertex *v, int h, Vertex *newdst)	",
"{	Edge *e, *f = (Edge *) 0, *g;",
"	int i;",
"",
"	",
