...
fprintf(th, "	#define HAS_LAST	1 \n");
fprintf(th, "	#ifndef STORE_LAST\n");
fprintf(th, "		#define NO_LAST	1 \n");
fprintf(th, "	#endif\n");
fprintf(th, "#endif\n");
...
fprintf(tc, "#endif\n");
fprintf(tc, "State	A_Root;	\n");
fprintf(tc, "State	now;	\n");
plunk_c_fcts(tc);
if (separate != 2)
...
j = e->merge;
haveit:
fprintf(tt, "%ssettr(%d,%d,%d,%d,%d,\"", fromcache?" ":"",
