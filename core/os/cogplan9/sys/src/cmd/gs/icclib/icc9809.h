...
#define icMagicNumber 0x61637370L
#define icVersionNumber 0x02200000L
#define icPrtrDefaultScreensFalse 0x00000000L
#define icPrtrDefaultScreensTrue 0x00000001L
#define icLinesPerInch 0x00000002L
#define icLinesPerCm 0x00000000L
#define icReflective 0x00000000L
#define icTransparency 0x00000001L
#define icGlossy 0x00000000L
#define icMatte 0x00000002L
#define icPositive 0x00000000L
#define icNegative 0x00000004L
#define icColor 0x00000000L
#define icBlackAndWhite 0x00000008L
#define icEmbeddedProfileFalse 0x00000000L
#define icEmbeddedProfileTrue 0x00000001L
#define icUseAnywhere 0x00000000L
#define icUseWithEmbeddedDataOnly 0x00000002L
#define icAsciiData 0x00000000L
#define icBinaryData 0x00000001L
#define icPhColUnknown 0x0000
#define icPhColITU_R_BT_709 0x0001
#define icPhColSMPTE_RP145_1994 0x0002
#define icPhColEBU_Tech_3213_E 0x0003
#define icPhColP22 0x0004
...
icSigChromaticityTag = 0x6368726DL,
...
icSigDeviceSettingsTag = 0x64657673L,
...
icSigOutputResponseTag = 0x72657370L,
...
icSigVideoCardGammaTag = 0x76636774L,
...
icSigChromaticityType = 0x6368726DL,
icSigDataType = 0x64617461L,
icSigDateTimeType = 0x6474696DL,
icSigDeviceSettingsType = 0x64657673L,
...
icSigResponseCurveSet16Type = 0x72637332L,
...
icSigVideoCardGammaType = 0x76636774L,
...
icSigMch5Data = 0x4D434835L,
icSigMch6Data = 0x4D434836L,
icSigMch7Data = 0x4D434837L,
icSigMch8Data = 0x4D434838L,
...
typedef enum {
icSigResolution = 0x72736c6eL,
icSigMedia = 0x6d747970L,
icSigHalftone = 0x6866746eL,
...
typedef struct {
icUInt32Number numPlatforms;
icUInt32Number data[icAny];
}icSettingsData;
typedef struct {
icUInt16Number channels;
icUInt16Number numTypes;
icUInt32Number data[icAny];
}icResponse;
typedef struct {
icUInt16Number interval;
icUInt16Number pad;
icS15Fixed16Number measurement;
} icResponse16Number;
typedef struct {
