...
#include "gdevcmap.h"
#include "gshtx.h"
private int test1(gs_state *, gs_memory_t *);
private int test2(gs_state *, gs_memory_t *);
private int test3(gs_state *, gs_memory_t *);
private int test4(gs_state *, gs_memory_t *);
private int test5(gs_state *, gs_memory_t *);
private int test6(gs_state *, gs_memory_t *);
private int test7(gs_state *, gs_memory_t *);
private int test8(gs_state *, gs_memory_t *);
#ifdef CAPTURE
#include "k/capture.c"
private int test10(gs_state *, gs_memory_t *);
#endif
