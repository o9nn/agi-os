...
#define COMPRESSED_SEGMENT_COMMAND 0x80
#define UNCOMPRESSED_SEGMENT_COMMAND 0x7f
private int
...
byte *buf;
int compressed_raster = min(raster / 2, 510);
byte *compressed;
