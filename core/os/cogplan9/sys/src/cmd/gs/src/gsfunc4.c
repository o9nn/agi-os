...
OP_NUM1(PtCr_abs_int, PtCr_abs),
OP_NUM2(PtCr_add_int, PtCr_add),
OP_INT_BOOL2(PtCr_and),
OP_MATH2(PtCr_atan),
OP_INT2(PtCr_bitshift),
OP_NUM1(N, PtCr_ceiling),
OP_MATH1(PtCr_cos),
OP_NUM1(N, PtCr_cvi),
OP_NUM1(PtCr_int_to_float, N),
OP_MATH2(PtCr_div),
OP_MATH2(PtCr_exp),
OP_NUM1(N, PtCr_floor),
OP_INT2(PtCr_idiv),
OP_MATH1(PtCr_ln),
OP_MATH1(PtCr_log),
OP_INT2(PtCr_mod),
OP_NUM2(PtCr_mul_int, PtCr_mul),
OP_NUM1(PtCr_neg_int, PtCr_neg),
OP1(PtCr_not, PtCr_not, E),
OP_INT_BOOL2(PtCr_or),
OP_NUM1(N, PtCr_round),
OP_MATH1(PtCr_sin),
OP_MATH1(PtCr_sqrt),
OP_NUM2(PtCr_sub_int, PtCr_sub),
OP_NUM1(N, PtCr_truncate),
OP_INT_BOOL2(PtCr_xor),
OP_REL2(PtCr_eq_int, PtCr_eq),
OP_NUM2(PtCr_ge_int, PtCr_ge),
OP_NUM2(PtCr_gt_int, PtCr_gt),
OP_NUM2(PtCr_le_int, PtCr_le),
OP_NUM2(PtCr_lt_int, PtCr_lt),
OP_REL2(PtCr_ne_int, PtCr_ne),
OP1(E, PtCr_copy, E),
OP_ANY1(PtCr_dup),
OP_ANY2(PtCr_exch),
OP1(E, PtCr_index, E),
