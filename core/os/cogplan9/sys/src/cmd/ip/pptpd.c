...
PSHORT(buf+0, sizeof(buf));
PSHORT(buf+2, 1);
PLONG(buf+4, Magic);
PSHORT(buf+8, Rstart);
PSHORT(buf+12, Version);
buf[14] = 1;
PLONG(buf+16, Syncframe|Asyncframe);
PLONG(buf+20, Digital|Analog);
PSHORT(buf+24, Nchan);
PSHORT(buf+26, 1);
PSTRING(buf+28, host, 64);
PSTRING(buf+92, "plan 9", 64);
...
PSHORT(buf+2, 1);
PLONG(buf+4, Magic);
PSHORT(buf+8, Rcallout);
PSHORT(buf+12, id);
PSHORT(buf+14, id);
buf[16] = 1;
PLONG(buf+20, 10000000);
PSHORT(buf+24, c->recvwindow);
PSHORT(buf+26, 0);
PLONG(buf+28, 0);
if(write(1, buf, sizeof(buf)) < sizeof(buf))
myfatal("write failed: %r");
...
v6tov4(buf+0, srv.local);
v6tov4(buf+4, srv.remote);
