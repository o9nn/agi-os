...
IDLE_TIME = 10,
NBNSTOUT = 300,
NBRPCTOUT = 45*60*1000,
MAX_SHARES = 4096,
RAP_ERR_MOREINFO= 234,
MAX_DFS_PATH = 512,
};
enum {
...
enum {
DFS_HEADER_ROOT = 1,
DFS_HEADER_STORAGE = 2,
DFS_HEADER_FAILBACK = 4,
};
enum {
DFS_SERVER_ROOT = 1,
DFS_REFERAL_LIST = 0x200,
DFS_REFERAL_SET = 0x400,
};
enum {
STYPE_DISKTREE = 0,
STYPE_PRINTQ = 1,
