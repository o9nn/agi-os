...
ulBeginSectInfo = ulGetLong(0x88, aucHeader);
DBG_HEX(ulBeginSectInfo);
tSectInfoLen = (size_t)ulGetLong(0x8c, aucHeader);
...
fail(ulStartBlock > MAX_BLOCKNUMBER && ulStartBlock != END_OF_CHAIN);
fail(aulBBD == NULL);
ulBeginHdrFtrInfo = ulGetLong(0xb0, aucHeader);
NO_DBG_HEX(ulBeginHdrFtrInfo);
tHdrFtrInfoLen = (size_t)ulGetLong(0xb4, aucHeader);
...
fail(ulStartBlock > MAX_BLOCKNUMBER && ulStartBlock != END_OF_CHAIN);
fail(aulBBD == NULL);
ulBeginParfInfo = ulGetLong(0xc0, aucHeader);
...
fail(ulStartBlock > MAX_BLOCKNUMBER && ulStartBlock != END_OF_CHAIN);
fail(aulBBD == NULL);
ulBeginCharInfo = ulGetLong(0xb8, aucHeader);
