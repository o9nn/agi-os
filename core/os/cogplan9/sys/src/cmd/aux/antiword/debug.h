...
#endif
#define NO_DBG_MSG(t)
#define NO_DBG_STRN(t,m)
#define NO_DBG_CHR(m)
#define NO_DBG_DEC(m)
#define NO_DBG_HEX(m)
#define NO_DBG_FLT(m)
#define NO_DBG_PRINT_BLOCK(b,m)
#define NO_DBG_UNICODE(t)
#define NO_DBG_UNICODE_N(t,m)
#define NO_DBG_MSG_C(c,t)
#define NO_DBG_STRN_C(c,t,m)
#define NO_DBG_CHR_C(c,m)
#define NO_DBG_DEC_C(c,m)
#define NO_DBG_HEX_C(c,m)
#define NO_DBG_FLT_C(c,m)
#if defined(TRACE)
