...
PanelVertCenterReg4 = 0x32,
PanelHorizCenterReg1 = 0x33,
PanelHorizCenterReg2 = 0x34,
PanelHorizCenterReg3 = 0x35,
PanelHorizCenterReg4 = 0x36,
PanelVertCenterReg5 = 0x37,
PanelHorizCenterReg5 = 0x38,
...
vga->crt[0x0C] = 0;
vga->crt[0x0D] = 0;
vga->graphics[GeneralLockReg] = 0x01;
...
vga->graphics[PanelDispCntlReg1] &= 0xDC;
