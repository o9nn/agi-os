...
|| !smbbufferputb(s->response, 3)
|| !smbbufferputs(s->response, 1)
|| !smbbufferputs(s->response, 1)
|| !smbbufferputl(s->response, smbglobals.maxreceive)
|| !smbbufferputl(s->response, 0x10000)
|| !smbbufferputl(s->response, threadid()))
goto die;
