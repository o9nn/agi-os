...
void label(char *s, int t, int nh)
{
int q;
char *p;
if (!s)
...
void arc(double x, double y, double x0, double y0, double x1, double y1)
{
move(x0, y0);
hvflush();
