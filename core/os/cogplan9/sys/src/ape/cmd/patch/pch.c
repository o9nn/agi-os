...
static LINENUM p_prefix_context;
static LINENUM p_suffix_context;
static LINENUM p_input_line;
static char **p_line;
static size_t *p_len;
static char *p_Char;
static LINENUM hunkmax = INITHUNKMAX;
static int p_indent;
...
register LINENUM fillcnt = 0;
register LINENUM fillsrc;
register LINENUM filldst;
...
LINENUM repl_context;
LINENUM ptrn_prefix_context = -1;
LINENUM ptrn_suffix_context = -1;
LINENUM repl_prefix_context = -1;
