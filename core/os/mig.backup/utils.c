...
{
fprintf(file, "\tchar *%s ", arg->argVarName, it->itNumber);
} else {
...
arg->argLongForm, true, true, arg->argTTName);
}
void
...
WriteStaticDecl(file, arg->argType,
arg->argType->itIndefinite ? d_NO : arg->argDeallocate,
arg->argLongForm, true, false, arg->argTTName);
}
void
...
WriteStaticDecl(file, arg->argType,
arg->argType->itIndefinite ? d_NO : arg->argDeallocate,
arg->argLongForm, false, true, arg->argTTName);
}
void
...
WriteStaticDecl(file, arg->argType,
arg->argType->itIndefinite ? d_NO : arg->argDeallocate,
arg->argLongForm, false, false, arg->argTTName);
}
void
