...
{ icondraw, outlinehighlight, simpleclip, iconscroll, },
{ textdraw, texthighlight, simpleclip, textscroll, },
{ textdraw, outlinehighlight, simpleclip, textscroll, },
{ listdraw, outlinehighlight, horizontalclip, horizontalscroll, },
{ listdraw, outlinehighlight, verticalclip, verticalscroll, },
{ icondraw, outlinehighlight, simpleclip, iconscroll, },
};
Point
