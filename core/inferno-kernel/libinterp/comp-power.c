...
AIRR(Ostw, Rfp, Ro1,O(Frame,fp));
AIRR(Ostw, Ro3, Ro1,O(Frame,mr));
opwst(i, Olwz, Ri);
if((i->add&ARM) == AXIMM) {
mem(Olwz, OA(Modlink, links)+i->reg*sizeof(Modl)+O(Modl, u.pc), Ri, Rj);
} else {
op2(i, Olwz, Rj);
SLWI(Rj, Rj, 3);
ARRR(Oadd, Ri, Rj, Rj);
...
opwld(i, Olbz, Ro1);
AIRR(Ocmpi, Rcrf0, Ro1, i->reg&0xFF);
} else {
op12(i, 1, 1);
ARRR(Ocmp, Rcrf0, Ro1, Ro2);
}
...
AIRR(Ostw, Rfp, Ro1,O(Frame,fp));
AIRR(Ostw, Ro2, Ro1,O(Frame,lr));
AIRR(Oaddi, Rfp, Ro1, 0);
...
ARRR(Oneg, Ri, Ri, 0);
if((i->add&ARM) != AXIMM)
ARRR(Ocmpl, Rcrf1, Ri, Ro2);
else
AIRR(Ocmpli, Rcrf1, Ri, i->reg);
...
mem(Olwz, (short)i->reg<<Lg2Rune, Ro1, Ro3);
gen(Ob | (2*4));
PATCH(cp);
if((i->add&ARM) != AXIMM)
...
opwst(i, Olwz, Ro3);
if(bflag){
AIRR(Olwz, Ro2, Ro1, O(Array, len));
ARRR(Ocmpl, Rcrf0, Ro3, Ro2);
jmpc(Cge, (ulong*)bounds);
}
AIRR(Olwz, Ro2, Ro1,O(Array,data));
switch(i->op) {
case IINDX:
AIRR(Olwz, Ri, Ro1,O(Array,t));
AIRR(Olwz, Ro1, Ri,O(Type,size));
ARRR(Omullw, Ro3, Ro3, Ro1);
break;
case IINDL:
case IINDF:
...
AIRR(Olwz, Ro3, Ro1,O(Modlink,compiled));
AIRR(Ocmpi, Rcrf0, Ro3, 0);
linterp = code;
br(Obeq, 0);
PATCH(cp4);
...
IRR(Olwz, 0,Ro3, Ro2);
IRR(Oaddi, 0,Ro3, Rlink);
loop = code;
AIRR(Ocmpi, Rcrf0, Ro2, 0);
cp1 = code;
br(Oble, 0);
LRRR(Osrawi, Ri, Ro2, 1);
SLWI(Rj, Ri, 1);
ARRR(Oadd, Rj, Rj, Ri);
SLWI(Rj, Rj, 2);
ARRR(Oadd, Rj, Rj, Ro3);
...
IRR(Oaddi, 12, Rj, Ro3);
IRR(Oaddi, 1, Ri, Rpic);
RRR(Osubf, Ro2, Rpic, Ro2);
jmp(loop);
PATCH(cp1);
IRR(Olwz, 0,Rlink, Ro2);
SLWI(Ro3, Ro2, 1);
...
mfspr(Rlink, Rlr);
AIRR(Ostw, Rlink, Ro1,O(Frame,lr));
AIRR(Ocmpi, Rcrf0, Ro2, 0);
AIRR(Oaddi, Rfp, Ro1, 0);
cp = code;
br(Obne, 0);
...
{
ulong *cp;
AIRR(Olwz, Ro2, Ri,O(Type,size));
AIRR(Olwz, Ro1, Rreg,O(REG,SP));
AIRR(Olwz, Ro3, Rreg,O(REG,TS));
ARRR(Oadd, Ro2, Ro2, Ro1);
ARRR(Ocmpl, Rcrf0, Ro2, Ro3);
cp = code;
br(Obge, 0);
AIRR(Olwz, Rj, Ri,O(Type,initialize));
mtspr(Rctr, Rj);
AIRR(Ostw, Ro2, Rreg,O(REG,SP));
AIRR(Ostw, Rzero, Ro1,O(Frame,mr));
AIRR(Ostw, Ri, Ro1,O(Frame,t));
gen(Obctr);
PATCH(cp);
AIRR(Ostw, Ri, Rreg,O(REG,s));
mfspr(Rlink, Rlr);
...
{
ulong *cp;
AIRR(Oaddi, Ro1, Ro1, -adj);
AIRR(Oaddi, Ro3, Ro3, -adj);
mtspr(Rctr, Ro2);
cp = code;
AIRR(ldu, Ri, Ro1,adj);
AIRR(stu, Ri, Ro3,adj);
br(Obc | Cdnz, ((ulong)cp-(ulong)code));
}
static void
movmem(Inst *i)
{
...
AIRR(Olwz, Ri, Ri,0);
AIRR(Olwz, Ro3, Ro1,O(Heap,color)-sizeof(Heap));
AIRR(Olwz, Ro2, Ro1,O(Heap,ref)-sizeof(Heap));
ARRR(Ocmp, Rcrf0, Ri, Ro3);
AIRR(Oaddi, Ro2, Ro2, 1);
AIRR(Ostw, Ro2, Ro1,O(Heap,ref)-sizeof(Heap));
gen(Obclr | Ceq);
ldc(propagator, Ro3);
AIRR(Ostw, Ro3, Ro1,O(Heap,color)-sizeof(Heap));
ldc((ulong)&nprop, Ro3);
AIRR(Ostw, Ro1, Ro3,0);
LRET();
}
...
PATCH(cp);
ARRR(Ofadd, Rf1, Rf1, Rf2);
ARRR(Ofctiwz, Rf2, 0, Rf1);
if(0){
AIRR(Ostfdu, Rf2, Rsp,-8);
}else{
AIRR(Oaddi, Rsp, Rsp, -8);
AIRR(Ostfd, Rf2, Rsp,0);
}
AIRR(Olwz, Ro1, Rsp,4);
AIRR(Oaddi, Rsp, Rsp, 8);
LRET();
...
macrelq(void)
{
ARRR(Ocrxor, Rcrbrel, Rcrbrel, Rcrbrel);
mfspr(Rlink, Rlr);
IRR(Ostw, O(REG,FP),Rreg, Rfp);
