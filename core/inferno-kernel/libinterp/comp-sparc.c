...
NOOP;
MOV(RA3, RA2);
FM3I(2, Osra, 1, RA2, RA2);
MOV(RA2, RA1);
FM3I(2, Osll, 1, RA1, RA1);
FM3(2, Oadd, RA2, RA1, RA1);
FM3I(2, Osll, 2, RA1, RA1);
FM3(3, Oldw, RA1, RCON, RTA);
...
mem(Oldw, O(Modlink,compiled),RA1, RA2);
...
NOOP;
PATCH(lab1);
mem(Oldw, O(REG, SP), RREG, RA2);
mem(Ostw, O(REG, SP), RREG, RA0);
mem(Ostw, O(Frame, t), RA2, RA3);
mem(Oldw, O(Type, initialize), RA3, RA3);
FM3I(2, Ojmpl, 0, RA3, RZ);
mem(Ostw, REGMOD*4, RA2, RZ);
}
static void
macmfra(void)
{
