...
modrm(Ostw, O(Frame, fp), RCX, RFP);
modrm(Oldw, O(REG, M), RTMP, RTA);
modrm(Ostw, O(Frame, mr), RCX, RTA);
opwst(i, Oldw, RTA);
cmpl(RTA, (ulong)H);
gen2(Ojeqb, 0);
mlnil = code - 1;
...
modrm(Oldw, 0, RTA, RAX);
modrm(op, 0, RTMP, RAX);
modrm(Oldw, 4, RTA, RCX);
modrm(opc, 4, RTMP, RCX);
if((i->add&ARM) != AXNON)
opwst(i, Olea, RTA);
...
genw((ulong)base+patch[i-mod->prog+1]);
modrm(Ostw, O(Frame, fp), RAX, RFP);
gen2(Oldw, (3<<6)|(RFP<<3)|RAX);
if(UXDST(i->add) != DST(AIMM)){
...
if(bflag){
opwst(i, Oldw, RAX);
modrm(0x3b, O(Array, len), RTMP, RAX);
gen2(0x72, 5);
bra((ulong)bounds, Ocall);
modrm(Oldw, O(Array, t), RTMP, RTA);
modrm(0xf7, O(Type, size), RTA, 5);
}
else{
modrm(Oldw, O(Array, t), RTMP, RAX);
modrm(Oldw, O(Type, size), RAX, RAX);
if(UXDST(i->add) == DST(AIMM)) {
...
modrm(0x03, O(Array, data), RBX, RAX);
r = RMP;
if((i->add&ARM) == AXINF)
r = RFP;
...
opwst(i, Oldw, RTMP);
if(bflag){
modrm(0x3b, O(Array, len), RAX, RTMP);
gen2(0x72, 5);
bra((ulong)bounds, Ocall);
}
...
modrm(Olea, 4, RSI, RSI);
gen2(Oldw, (3<<6)|(RBX<<3)|RDX);
gen2(Oshr, (3<<6)|(4<<3)|RBX);
gen2(0x01, (3<<6)|(RDX<<3)|RBX);
...
gen2(Ojleb, 0);
def = code-1;
gen2(Oldw, (3<<6)|(RCX<<3)|RDX);
gen2(Oshr, (3<<6)|(5<<3)|RCX);
gen2(Oldw, (3<<6)|(RBX<<3)|RCX);
gen2(Oshr, (3<<6)|(4<<3)|RBX);
gen2(0x01, (3<<6)|(RCX<<3)|RBX);
...
gen2((2<<6)|(RBX<<3)|RSI, 4);
gen2(Ojltb, 0);
lab1 = code-1;
gen2(Olea, (1<<6)|(RSI<<3)|4);
gen2((2<<6)|(RBX<<3)|RSI, 12);
gen2(0x2b, (3<<6)|(RDX<<3)|RCX);
gen2(Odecrm, (3<<6)|(1<<3)|RDX);
gen2(Ojmpb, loop-code-2);
*lab1 = code-lab1-1;
gen2(Oldw, (1<<6)|(RAX<<3)|4);
gen2((2<<6)|(RBX<<3)|RSI, 8);
genb(Opopl+RSI);
genb(Opopl+RSI);
gen2(Ojmprm, (3<<6)|(4<<3)|RAX);
*def = code-def-1;
...
linterp -= 2;
con(0, RBX);
modrm(Oldw, O(Frame, t), RFP, RAX);
gen2(Ocmpw, (3<<6)|(RAX<<3)|RBX);
gen2(Ojeqb, lpunt-(code-s));
modrm(Oldw, O(Type, destroy), RAX, RAX);
gen2(Ocmpw, (3<<6)|(RAX<<3)|RBX);
gen2(Ojeqb, lpunt-(code-s));
modrm(Ocmpw, O(Frame, fp), RFP, RBX);
gen2(Ojeqb, lpunt-(code-s));
modrm(Ocmpw, O(Frame, mr), RFP, RBX);
...
lfrmr = code - s;
modrm(Oldw, O(Frame, mr), RFP, RTA);
modrm(Ostw, O(REG, M), RTMP, RTA);
modrm(Oldw, O(Modlink, MP), RTA, RMP);
modrm(Ostw, O(REG, MP), RTMP, RMP);
modrm(Ocmpi, O(Modlink, compiled), RTA, 7);
genb(0x00);
gen2(Ojeqb, linterp-(code-s));
lnomr = code - s;
gen2(Ocallrm, (3<<6)|(2<<3)|RAX);
con((ulong)&R, RTMP);
modrm(Ostw, O(REG, SP), RTMP, RFP);
modrm(Oldw, O(Frame, lr), RFP, RAX);
modrm(Oldw, O(Frame, fp), RFP, RFP);
modrm(Ostw, O(REG, FP), RTMP, RFP);
gen2(Ojmprm, (3<<6)|(4<<3)|RAX);
linterp = code - s;
gen2(Ocallrm, (3<<6)|(2<<3)|RAX);
...
gen2(Ojeqb, 0);
mlnil = code - 1;
modrm(0x83, O(Modlink, prog), RTA, 7);
genb(0x00);
gen2(Ojneb, 0);
label = code-1;
*mlnil = code-mlnil-1;
...
bra((ulong)rmcall, Ocall);
con((ulong)&R, RTMP);
modrm(Oldw, O(REG, FP), RTMP, RFP);
modrm(Oldw, O(REG, MP), RTMP, RMP);
genb(Oret);
*label = code-label-1;
gen2(Oldw, (3<<6)|(RFP<<3)|RCX);
modrm(Ostw, O(REG, M), RTMP, RTA);
modrm(Oincrm, O(Heap, ref)-sizeof(Heap), RTA, 0);
modrm(Oldw, O(Modlink, MP), RTA, RMP);
modrm(Ostw, O(REG, MP), RTMP, RMP);
...
uchar *label;
con((ulong)&R, RTMP);
modrm(Oldw, O(REG, SP), RTMP, RAX);
modrm(0x03, O(Type, size), RTA, RAX);
modrm(0x3b, O(REG, TS), RTMP, RAX);
gen2(0x7c, 0x00);
label = code-1;
modrm(Ostw, O(REG, s), RTMP, RTA);
modrm(Ostw, O(REG, FP), RTMP, RFP);
bra((ulong)extend, Ocall);
con((ulong)&R, RTMP);
modrm(Oldw, O(REG, FP), RTMP, RFP);
modrm(Oldw, O(REG, MP), RTMP, RMP);
modrm(Oldw, O(REG, s), RTMP, RCX);
genb(Oret);
*label = code-label-1;
modrm(Oldw, O(REG, SP), RTMP, RCX);
modrm(Ostw, O(REG, SP), RTMP, RAX);
modrm(Ostw, O(Frame, t), RCX, RTA);
modrm(Omov, REGMOD*4, RCX, 0);
genw(0);
...
modrm(Ostw, O(REG, FP), RTMP, RFP);
modrm(Ostw, O(REG, s), RTMP, RAX);
modrm(Ostw, O(REG, d), RTMP, RTA);
bra((ulong)rmfram, Ocall);
con((ulong)&R, RTMP);
modrm(Oldw, O(REG, FP), RTMP, RFP);
modrm(Oldw, O(REG, MP), RTMP, RMP);
genb(Oret);
