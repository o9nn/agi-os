...
case 5:
v = regoff(&p->from);
o1 = 0x1000000 | (REGTMP<<25) | ((v>>10) & 0x3fffff);
...
case 13:
v = regoff(&p->from);
o1 = 0x1000000 | (p->to.reg<<25) | ((v>>10) & 0x3fffff);
break;
case 20:
v = regoff(&p->from);
r = p->reg;
...
case AMOVBU:	return OP3(1);
case AMOVB:	return OP3(9);
case AMOVHU:	return OP3(2);
case AMOVH:	return OP3(10);
case AMOVW:	return OP3(0);
case AMOVD:	return OP3(3);
case AMOVBU+AEND:
case AMOVB+AEND:return OP3(5);
case AMOVHU+AEND:
case AMOVH+AEND:return OP3(6);
case AMOVW+AEND:return OP3(4);
case AMOVD+AEND:return OP3(7);
case ASWAP:
case ASWAP+AEND:return OP3(15);
case ATAS:	return OP3(13);
