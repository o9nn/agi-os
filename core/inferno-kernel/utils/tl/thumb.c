...
o1 = (0x15<<11) | (rt<<8) | (instoffset>>2);
}
else if(rf == rt){
numr(p, instoffset, 0, 255);
o1 = (0x6<<11) | (rt<<8) | instoffset;
}
else{
lowreg(p, rf);
numr(p, instoffset, 0, 7);
o1 = (0xe<<9) | (instoffset<<6) | (rf<<3) | rt;
}
break;
case 26:
lowreg(p, rt);
...
o1 = mv(p, r, instoffset);
if(high(rf))
o2 = (0x44<<8) | (0x1<<6) | ((rf-8)<<3) | rt;
else
o2 = (0x6<<10) | (rf<<6) | (rt<<3) | rt;
break;
case 36:
thumbaclass(&p->from, p);
lowreg(p, r);
...
case 42:
thumbaclass(&p->to, p);
o1 = (0xd<<12) | thumbopbra(relinv(p->as)) | (6>>1);
o2 = (0x9<<11) | (REGTMPT<<8);
o3 = mvlh(REGTMPT, REGPC);
o4 = instoffset&0xffff;
o5 = (instoffset>>16)&0xffff;
break;
case 43:
thumbaclass(&p->to, p);
o1 = mvlh(REGPC, REGTMPT);
o2 = (0x6<<11) | (REGTMPT<<8) | 10;
o3 = mvlh(REGTMPT, REGLINK);
o4 = (0x9<<11) | (REGTMPT<<8);
o5 = mvlh(REGTMPT, REGPC);
o6 = instoffset&0xffff;
...
case 46:
thumbaclass(&p->to, p);
o1 = (0xd<<12) | thumbopbra(relinv(p->as)) | (0>>1);
instoffset -= 2;
numr(p, instoffset, -2048, 2046);
