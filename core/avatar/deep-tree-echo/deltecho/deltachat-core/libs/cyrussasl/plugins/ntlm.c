...
p += SMB_HDR_SIZE;
len -= SMB_HDR_SIZE;
if (memcmp(hdr.protocol, SMB_HDR_PROTOCOL, 4)
|| hdr.command != SMB_COM_NEGOTIATE_PROTOCOL
|| hdr.status
|| !(hdr.flags & SMB_FLAGS_SERVER_TO_REDIR)) {
utils->log(NULL, SASL_LOG_ERR,
...
NULL,
&ntlm_server_mech_new,
&ntlm_server_mech_step,
&ntlm_server_mech_dispose,
NULL,
NULL,
NULL,
NULL,
...
NULL,
NULL,
&ntlm_client_mech_new,
&ntlm_client_mech_step,
&ntlm_client_mech_dispose,
NULL,
NULL,
NULL,
NULL
