...
"nntp-cached",
nntpdriver_cached_initialize,
nntpdriver_cached_uninitialize,
nntpdriver_cached_parameters,
nntpdriver_cached_connect_stream,
NULL,
NULL,
nntpdriver_cached_login,
nntpdriver_cached_logout,
nntpdriver_cached_noop,
NULL,
NULL,
NULL,
NULL,
nntpdriver_cached_check_folder,
NULL,
nntpdriver_cached_select_folder,
NULL,
nntpdriver_cached_status_folder,
nntpdriver_cached_messages_number,
nntpdriver_cached_recent_number,
nntpdriver_cached_unseen_number,
nntpdriver_cached_list_folders,
nntpdriver_cached_lsub_folders,
nntpdriver_cached_subscribe_folder,
nntpdriver_cached_unsubscribe_folder,
nntpdriver_cached_append_message,
nntpdriver_cached_append_message_flags,
NULL,
NULL,
nntpdriver_cached_get_message,
nntpdriver_cached_get_message_by_uid,
nntpdriver_cached_get_messages_list,
nntpdriver_cached_get_envelopes_list,
NULL,
#if 0
