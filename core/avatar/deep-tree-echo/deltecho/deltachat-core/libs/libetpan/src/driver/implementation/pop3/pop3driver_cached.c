...
"pop3-cached",
pop3driver_cached_initialize,
pop3driver_cached_uninitialize,
pop3driver_cached_parameters,
pop3driver_cached_connect_stream,
NULL,
pop3driver_cached_starttls,
pop3driver_cached_login,
pop3driver_cached_logout,
pop3driver_cached_noop,
NULL,
NULL,
NULL,
NULL,
pop3driver_cached_check_folder,
NULL,
NULL,
pop3driver_cached_expunge_folder,
pop3driver_cached_status_folder,
pop3driver_cached_messages_number,
pop3driver_cached_recent_number,
pop3driver_cached_unseen_number,
NULL,
NULL,
NULL,
NULL,
...
NULL,
NULL,
pop3driver_cached_get_message,
pop3driver_cached_get_message_by_uid,
pop3driver_cached_get_messages_list,
pop3driver_cached_get_envelopes_list,
pop3driver_cached_remove_message,
#if 0
maildriver_generic_search_messages,
#endif
pop3driver_cached_login_sasl
};
