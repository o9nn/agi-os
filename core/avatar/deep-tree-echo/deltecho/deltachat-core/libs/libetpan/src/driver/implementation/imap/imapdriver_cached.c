...
"imap-cached",
imapdriver_cached_initialize,
imapdriver_cached_uninitialize,
imapdriver_cached_parameters,
imapdriver_cached_connect_stream,
NULL,
imapdriver_cached_starttls,
imapdriver_cached_login,
imapdriver_cached_logout,
imapdriver_cached_noop,
imapdriver_cached_build_folder_name,
imapdriver_cached_create_folder,
imapdriver_cached_delete_folder,
imapdriver_cached_rename_folder,
imapdriver_cached_check_folder,
imapdriver_cached_examine_folder,
imapdriver_cached_select_folder,
imapdriver_cached_expunge_folder,
imapdriver_cached_status_folder,
imapdriver_cached_messages_number,
imapdriver_cached_recent_number,
imapdriver_cached_unseen_number,
imapdriver_cached_list_folders,
imapdriver_cached_lsub_folders,
imapdriver_cached_subscribe_folder,
imapdriver_cached_unsubscribe_folder,
imapdriver_cached_append_message,
imapdriver_cached_append_message_flags,
imapdriver_cached_copy_message,
NULL,
imapdriver_cached_get_message,
imapdriver_cached_get_message_by_uid,
imapdriver_cached_get_messages_list,
imapdriver_cached_get_envelopes_list,
imapdriver_cached_remove_message,
#if 0
imapdriver_cached_search_messages,
#endif
imapdriver_cached_login_sasl
};
