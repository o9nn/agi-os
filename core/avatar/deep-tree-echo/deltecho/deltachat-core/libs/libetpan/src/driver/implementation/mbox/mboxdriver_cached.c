...
"mbox-cached",
mboxdriver_cached_initialize,
mboxdriver_cached_uninitialize,
mboxdriver_cached_parameters,
NULL,
mboxdriver_cached_connect_path,
NULL,
NULL,
mboxdriver_cached_logout,
NULL,
NULL,
NULL,
NULL,
NULL,
mboxdriver_cached_check_folder,
NULL,
NULL,
mboxdriver_cached_expunge_folder,
mboxdriver_cached_status_folder,
mboxdriver_cached_messages_number,
mboxdriver_cached_recent_number,
mboxdriver_cached_unseen_number,
NULL,
NULL,
NULL,
NULL,
mboxdriver_cached_append_message,
mboxdriver_cached_append_message_flags,
NULL,
NULL,
mboxdriver_cached_get_message,
mboxdriver_cached_get_message_by_uid,
mboxdriver_cached_get_messages_list,
mboxdriver_cached_get_envelopes_list,
mboxdriver_cached_remove_message,
#if 0
