...
mailstream_low_cfstream_read,
mailstream_low_cfstream_write,
mailstream_low_cfstream_close,
mailstream_low_cfstream_get_fd,
mailstream_low_cfstream_free,
mailstream_low_cfstream_cancel,
NULL,
mailstream_low_cfstream_get_certificate_chain,
mailstream_low_cfstream_setup_idle,
mailstream_low_cfstream_unsetup_idle,
mailstream_low_cfstream_interrupt_idle,
};
