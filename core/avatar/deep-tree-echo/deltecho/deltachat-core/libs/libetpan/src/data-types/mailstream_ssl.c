...
mailstream_low_ssl_read,
mailstream_low_ssl_write,
mailstream_low_ssl_close,
mailstream_low_ssl_get_fd,
mailstream_low_ssl_free,
mailstream_low_ssl_cancel,
mailstream_low_ssl_get_cancel,
mailstream_low_ssl_get_certificate_chain,
NULL,
NULL,
NULL,
};
