...
"imap",
imapdriver_initialize,
imapdriver_uninitialize,
imapdriver_parameters,
imapdriver_connect_stream,
NULL,
imapdriver_starttls,
imapdriver_login,
imapdriver_logout,
imapdriver_noop,
imapdriver_build_folder_name,
imapdriver_create_folder,
imapdriver_delete_folder,
imapdriver_rename_folder,
imapdriver_check_folder,
imapdriver_examine_folder,
imapdriver_select_folder,
imapdriver_expunge_folder,
imapdriver_status_folder,
imapdriver_messages_number,
imapdriver_recent_number,
imapdriver_unseen_number,
imapdriver_list_folders,
imapdriver_lsub_folders,
imapdriver_subscribe_folder,
imapdriver_unsubscribe_folder,
imapdriver_append_message,
imapdriver_append_message_flags,
imapdriver_copy_message,
NULL,
imapdriver_get_message,
imapdriver_get_message_by_uid,
imapdriver_get_messages_list,
imapdriver_get_envelopes_list,
imapdriver_remove_message,
imapdriver_login_sasl
};
