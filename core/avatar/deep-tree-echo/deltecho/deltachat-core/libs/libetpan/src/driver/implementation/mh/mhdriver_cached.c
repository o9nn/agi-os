...
"mh-cached",
mhdriver_cached_initialize,
mhdriver_cached_uninitialize,
mhdriver_cached_parameters,
NULL,
mhdriver_cached_connect_path,
NULL,
NULL,
mhdriver_cached_logout,
NULL,
mhdriver_cached_build_folder_name,
mhdriver_cached_create_folder,
mhdriver_cached_delete_folder,
mhdriver_cached_rename_folder,
mhdriver_cached_check_folder,
NULL,
mhdriver_cached_select_folder,
mhdriver_cached_expunge_folder,
mhdriver_cached_status_folder,
mhdriver_cached_messages_number,
mhdriver_cached_recent_number,
mhdriver_cached_unseen_number,
mhdriver_cached_list_folders,
mhdriver_cached_lsub_folders,
mhdriver_cached_subscribe_folder,
mhdriver_cached_unsubscribe_folder,
mhdriver_cached_append_message,
mhdriver_cached_append_message_flags,
mhdriver_cached_copy_message,
mhdriver_cached_move_message,
mhdriver_cached_get_message,
mhdriver_cached_get_message_by_uid,
mhdriver_cached_get_messages_list,
mhdriver_cached_get_envelopes_list,
mhdriver_cached_remove_message,
#if 0
