...
bool lost_prematurely:1;
bool closing:1;
bool disconnected:1;
bool close_indicated:1;
bool output_locked:1;
bool output_broken:1;
bool in_req_callback:1;
bool debug:1;
};
struct http_client_peer_shared {
unsigned int refcount;
...
bool no_payload_sync:1;
bool seen_100_response:1;
bool allows_pipelining:1;
};
struct http_client_peer_pool {
unsigned int refcount;
...
bool connect_failed:1;
bool connect_backoff:1;
bool disconnected:1;
bool handling_requests:1;
};
struct http_client_queue {
struct http_client *client;
