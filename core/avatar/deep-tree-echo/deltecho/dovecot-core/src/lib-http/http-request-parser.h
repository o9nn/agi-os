...
HTTP_REQUEST_PARSE_ERROR_NONE = 0,
HTTP_REQUEST_PARSE_ERROR_BROKEN_STREAM,
HTTP_REQUEST_PARSE_ERROR_BROKEN_REQUEST,
HTTP_REQUEST_PARSE_ERROR_BAD_REQUEST,
HTTP_REQUEST_PARSE_ERROR_NOT_IMPLEMENTED,
HTTP_REQUEST_PARSE_ERROR_EXPECTATION_FAILED,
HTTP_REQUEST_PARSE_ERROR_METHOD_TOO_LONG,
HTTP_REQUEST_PARSE_ERROR_TARGET_TOO_LONG,
HTTP_REQUEST_PARSE_ERROR_PAYLOAD_TOO_LARGE
};
