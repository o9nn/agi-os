...
(type vertex-type set-vertex-type!)
...
(vertices edge-vertices set-edge-vertices!)
(weights edge-weights set-edge-weights!)
(operation edge-operation set-edge-operation!)
(tree-structure edge-tree-structure set-edge-tree-structure!))
