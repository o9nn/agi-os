...
_hypcall1(long, set_trap_table, vm_offset_t , traps);
#ifdef MACH_PV_PAGETABLES
_hypcall4(int, mmu_update, vm_offset_t , req, int, count, vm_offset_t , success_count, domid_t, domid)
...
_hypcall2(long, memory_op, unsigned long, cmd, vm_offset_t , arg);
...
#ifdef MACH_PV_PAGETABLES
_hypcall4(int, mmuext_op, vm_offset_t , op, int, count, vm_offset_t , success_count, domid_t, domid);
...
_hypcall1(int, event_channel_op, vm_offset_t , op);
...
_hypcall3(int, console_io, int, cmd, int, count, vm_offset_t , buffer);
_hypcall3(long, grant_table_op, unsigned int, cmd, vm_offset_t , uop, unsigned int, count);
_hypcall2(long, vm_assist, unsigned int, cmd, unsigned int, type);
_hypcall0(long, iret);
#include <xen/public/sched.h>
_hypcall2(long, sched_op, int, cmd, vm_offset_t , arg)
