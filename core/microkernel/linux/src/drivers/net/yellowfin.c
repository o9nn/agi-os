...
outl(0x00800080, ioaddr + TxIntrSel);
outl(0x00800080, ioaddr + TxBranchSel);
outl(0x00400040, ioaddr + TxWaitSel);
outl(0x00400040, ioaddr + RxIntrSel);
outl(0x00400040, ioaddr + RxBranchSel);
outl(0x00400040, ioaddr + RxWaitSel);
...
outw(0x81ff, ioaddr + IntrEnb);
outw(0x0000, ioaddr + EventStatus);
outl(0x80008000, ioaddr + RxCtrl);
