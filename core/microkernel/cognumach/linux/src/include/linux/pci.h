...
unsigned long flags;
char *name;
struct pci_resource *parent;
struct pci_resource *sibling;
struct pci_resource *child;
};
struct pci_dev {
struct pci_bus *bus;
...
unsigned int pcie_type : 4;
unsigned int reserved_flags : 26;
unsigned char irq;
unsigned int pcie_cap;
#define PCI_NUM_RESOURCES 6
struct pci_resource resource[PCI_NUM_RESOURCES];
};
struct pci_bus {
...
#define PCI_IORESOURCE_SIZEALIGN 0x00040000
#define PCI_IORESOURCE_STARTALIGN 0x00080000
#define PCI_IORESOURCE_DISABLED 0x10000000
#define PCI_IORESOURCE_UNSET 0x20000000
#define PCI_IORESOURCE_AUTO 0x40000000
#define PCI_IORESOURCE_BUSY 0x80000000
struct pci_dev_info {
unsigned short vendor;
unsigned short device;
const char *name;
