...
unknown, "Read TOC", unknown, unknown, unknown, unknown, unknown,
unknown, unknown, unknown, "Log Select", "Log Sense", unknown, unknown,
...
"Good", "Check Condition", "Condition Good", unknown, "Busy",
unknown, unknown, unknown, "Intermediate Good", unknown,
"Intermediate Good", unknown, "Reservation Conflict", unknown,
unknown, unknown,
};
#endif
...
"Command Complete", NULL, "Save Pointers",
"Restore Pointers", "Disconnect", "Initiator Error",
"Abort", "Message Reject", "Nop", "Message Parity Error",
