...
if(devnum & 0x80)
return(-1);
mech2bus = (UCHAR)((devnum & 0xff00) >> 8);
mech2Agent = ((UCHAR)(devnum & 0xff)) >> 3;
mech2Agent |= 0xc0;
mech2CfgSPenR = ((UCHAR)(devnum & 0xff)) & 0x07;
...
adaptCnt++;
pci_index++;
istatus = inb( (USHORT)io_port+INT_Status );
#ifdef DC390_DEBUG0
