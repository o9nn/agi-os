...
#ifdef	MACHINE_STACK
#else
def_simple_lock_data(static, stack_lock_data)
...
thread_template.cpu_affinity = CPU_AFFINITY_ANY;
#endif
...
if (parent_task->thread_count >= 1000) {
