...
#md plot(prob)
# To solve our problem, we will use [`EQSearch`](@ref), which provides a wrapper for the [symbolic regression interface](https:
...
# symbolic regressions [`EquationSearch`](https:
# is `maxiters`
